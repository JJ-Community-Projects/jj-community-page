  ...
  const week1: UserStream[] = [
    {
      stream: {
        ...
        scheduleId: 1,
        createdBy: 101,
        title: "THE YOGSCAST'S JINGLE CATS",
        visible: true,
        subtitle: null,
        description:
          "Kick off Jingle Jam 2025 with Lewis and Simon's yearly tradition...reacting to fan-made 'Jingle Cats' videos!",
        youtubeVodUrl: null,
        twitchVodUrl: null,
        start: new Date('2025-12-01T17:00:00.000Z'),
        end: new Date('2025-12-01T19:00:00.000Z'),
        isTimeTBD: false,
        participants: [],
        tags: [],
      },
    ...
    },
    {
      stream: {
        ...
        youtubeVodUrl: null,
        twitchVodUrl: null,
        start: new Date('2025-12-02T16:00:00.000Z'),
        end: new Date('2025-12-02T18:00:00.000Z'),
        isTimeTBD: false,
        participants: [],
        tags: [],
      },
    ...
    },
    {
      stream: {
        ...
        scheduleId: 1,
        createdBy: 101,
        title: 'HAT FILMS MUSIC STREAM',
        visible: true,
        subtitle: 'Smith, Ross and Trott',
        description:
          'Tune in on The Yogscast as Smith, Ross and Trott cook up some bangers for the annual Hat Films music stream.',
        youtubeVodUrl: null,
        twitchVodUrl: null,
    ...
    },
    {
      stream: {
        ...
        scheduleId: 1,
        createdBy: 101,
        title: "THE YOGSCAST'S CIV 5 ON THE 5TH",
        visible: true,
        subtitle: "12th annual Sid Meier's Civilization 5",
        description:
          "The 12th annual Sid Meier's Civilization 5 on the 5th with Lewis, Duncan, Kirsty, Rythian, Daltos, Alex the Rambler, and The Spiffing Brit.",
        youtubeVodUrl: null,
        twitchVodUrl: null,
        start: new Date('2025-12-05T17:00:00.000Z'),
        end: new Date('2025-12-05T19:00:00.000Z'),
        isTimeTBD: false,
        participants: [],
        tags: [],
      },
    ...
    },
    {
      stream: {
        ...
        scheduleId: 1,
        createdBy: 102,
        title: "DR. SIMON CLARK'S ANNUAL YOGSCAST QUIZ",
        visible: true,
        subtitle: null,
        description:
          'Dr. Simon Clark returns for his annual parody game show. Tune in as The Yogscast battle it out to become the Countjam! champion.',
        youtubeVodUrl: null,
        twitchVodUrl: null,
        start: new Date('2025-12-06T17:00:00.000Z'),
        end: new Date('2025-12-06T19:00:00.000Z'),
        isTimeTBD: false,
        participants: [],
        tags: [],
      },
    ...
    },
    {
      stream: {
        ...
        youtubeVodUrl: null,
        twitchVodUrl: null,
        start: new Date('2025-12-07T20:00:00.000Z'),
        end: new Date('2025-12-07T23:00:00.000Z'),
        isTimeTBD: true,
        participants: [],
        tags: [],
      },
    ...
    },
    {
      stream: {
        ...
        scheduleId: 1,
        createdBy: 101,
        title: "THE YOGSCAST'S ANNUAL POKER TOURNAMENT",
        visible: true,
        subtitle: 'Feat. PyrionFlax and AngoryTom',
        description:
          "Join PyrionFlax and AngoryTom for The Yogscast's annual poker tournament, featuring loads of your favourite Yogscast creators and friends.",
        youtubeVodUrl: null,
        twitchVodUrl: null,
        start: new Date('2025-12-07T17:00:00.000Z'),
        end: new Date('2025-12-07T19:00:00.000Z'),
        isTimeTBD: false,
        participants: [],
        tags: [],
      },
