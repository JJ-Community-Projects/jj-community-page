...
import type {
  NotFound,
  TeamCampaignPaginatedResponse1,
  TeamMemberPaginatedResponse1,
  TeamResponse1,
  Unauthorized,
  UnprocessableEntity,
} from '../models';
import {
    NotFoundFromJSON,
    NotFoundToJSON,
    TeamCampaignPaginatedResponse1FromJSON,
    TeamCampaignPaginatedResponse1ToJSON,
    TeamMemberPaginatedResponse1FromJSON,
    TeamMemberPaginatedResponse1ToJSON,
    TeamResponse1FromJSON,
    TeamResponse1ToJSON,
...
export interface GetTeamBySlugRequest {
    slug: string;
}

export interface GetTeamCampaignsRequest {
    teamId: string;
    status?: GetTeamCampaignsStatusEnum;
    supportingType?: GetTeamCampaignsSupportingTypeEnum;
    updatedAfter?: string;
...
export class TeamApi extends runtime.BaseAPI {
     ...
     * Get by ID
     */
    async getTeamRaw(requestParameters: GetTeamRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<TeamResponse1>> {
        ...
        const response = await this.request({
            path: `/api/public/teams/{team_id}`.replace(`{${"team_id"}}`, encodeURIComponent(String(requestParameters['teamId']))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => TeamResponse1FromJSON(jsonValue));
    }
     ...
     * Get by ID
     */
    async getTeam(requestParameters: GetTeamRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<TeamResponse1> {
     ...
     * Get by slug
     */
    async getTeamBySlugRaw(requestParameters: GetTeamBySlugRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<TeamResponse1>> {
        if (requestParameters['slug'] == null) {
            throw new runtime.RequiredError(
                'slug',
                'Required parameter "slug" was null or undefined when calling getTeamBySlug().'
            );
        }
        ...
        const response = await this.request({
            path: `/api/public/teams/by/slug/{slug}`.replace(`{${"slug"}}`, encodeURIComponent(String(requestParameters['slug']))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
     ...
     * Get by slug
     */
    async getTeamBySlug(requestParameters: GetTeamBySlugRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<TeamResponse1> {
        const response = await this.getTeamBySlugRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     * List Team Campaigns
     */
    async getTeamCampaignsRaw(requestParameters: GetTeamCampaignsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<TeamCampaignPaginatedResponse1>> {
        if (requestParameters['teamId'] == null) {
            throw new runtime.RequiredError(
                'teamId',
                'Required parameter "teamId" was null or undefined when calling getTeamCampaigns().'
            );
        }
        ...
        const response = await this.request({
            path: `/api/public/teams/{team_id}/team_campaigns`.replace(`{${"team_id"}}`, encodeURIComponent(String(requestParameters['teamId']))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => TeamCampaignPaginatedResponse1FromJSON(jsonValue));
    }

    /**
     * List Team Campaigns
     */
    async getTeamCampaigns(requestParameters: GetTeamCampaignsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<TeamCampaignPaginatedResponse1> {
        const response = await this.getTeamCampaignsRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     * List team members
     */
    async getTeamMembersRaw(requestParameters: GetTeamMembersRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<TeamMemberPaginatedResponse1>> {
        if (requestParameters['teamId'] == null) {
            throw new runtime.RequiredError(
                'teamId',
        ...
        const response = await this.request({
            path: `/api/public/teams/{team_id}/members`.replace(`{${"team_id"}}`, encodeURIComponent(String(requestParameters['teamId']))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => TeamMemberPaginatedResponse1FromJSON(jsonValue));
    }

    /**
     * List team members
     */
    async getTeamMembers(requestParameters: GetTeamMembersRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<TeamMemberPaginatedResponse1> {
 ...
 * @export
 */
export const GetTeamCampaignsStatusEnum = {
    Published: 'published',
    Retired: 'retired'
} as const;
export type GetTeamCampaignsStatusEnum = typeof GetTeamCampaignsStatusEnum[keyof typeof GetTeamCampaignsStatusEnum];
/**
 * @export
 */
export const GetTeamCampaignsSupportingTypeEnum = {
    InviteOnly: 'invite_only',
    None: 'none',
    Private: 'private',
    Public: 'public'
} as const;
export type GetTeamCampaignsSupportingTypeEnum = typeof GetTeamCampaignsSupportingTypeEnum[keyof typeof GetTeamCampaignsSupportingTypeEnum];
