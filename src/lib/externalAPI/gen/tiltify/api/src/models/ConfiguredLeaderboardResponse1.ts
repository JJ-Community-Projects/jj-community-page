...
import type { ConfiguredLeaderboard } from './ConfiguredLeaderboard';
import {
    ConfiguredLeaderboardFromJSON,
    ConfiguredLeaderboardFromJSONTyped,
    ConfiguredLeaderboardToJSON,
    ConfiguredLeaderboardToJSONTyped,
} from './ConfiguredLeaderboard';

/**
 * 
 * @export
 * @interface ConfiguredLeaderboardResponse1
 */
export interface ConfiguredLeaderboardResponse1 {
    /**
     * 
     * @type {ConfiguredLeaderboard}
     * @memberof ConfiguredLeaderboardResponse1
     */
    data?: ConfiguredLeaderboard;
}

/**
 * Check if a given object implements the ConfiguredLeaderboardResponse1 interface.
 */
export function instanceOfConfiguredLeaderboardResponse1(value: object): value is ConfiguredLeaderboardResponse1 {
    return true;
}

export function ConfiguredLeaderboardResponse1FromJSON(json: any): ConfiguredLeaderboardResponse1 {
    return ConfiguredLeaderboardResponse1FromJSONTyped(json, false);
}

export function ConfiguredLeaderboardResponse1FromJSONTyped(json: any, ignoreDiscriminator: boolean): ConfiguredLeaderboardResponse1 {
    if (json == null) {
        return json;
    }
    return {
        
        'data': json['data'] == null ? undefined : ConfiguredLeaderboardFromJSON(json['data']),
    };
}

export function ConfiguredLeaderboardResponse1ToJSON(json: any): ConfiguredLeaderboardResponse1 {
    return ConfiguredLeaderboardResponse1ToJSONTyped(json, false);
}

export function ConfiguredLeaderboardResponse1ToJSONTyped(value?: ConfiguredLeaderboardResponse1 | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': ConfiguredLeaderboardToJSON(value['data']),
    };
}
