...
import {
    AuctionBidFromJSON,
    AuctionBidFromJSONTyped,
    AuctionBidToJSON,
    AuctionBidToJSONTyped,
} from './AuctionBid';
 ...
 * 
 * @export
 * @interface AuctionBidPaginatedResponse1
 */
export interface AuctionBidPaginatedResponse1 {
    /**
     * 
     * @type {Array<AuctionBid>}
     * @memberof AuctionBidPaginatedResponse1
     */
    data?: Array<AuctionBid>;
    /**
     * 
...
/**
 * Check if a given object implements the AuctionBidPaginatedResponse1 interface.
 */
export function instanceOfAuctionBidPaginatedResponse1(value: object): value is AuctionBidPaginatedResponse1 {
    return true;
}

export function AuctionBidPaginatedResponse1FromJSON(json: any): AuctionBidPaginatedResponse1 {
    return AuctionBidPaginatedResponse1FromJSONTyped(json, false);
}

export function AuctionBidPaginatedResponse1FromJSONTyped(json: any, ignoreDiscriminator: boolean): AuctionBidPaginatedResponse1 {
    if (json == null) {
        return json;
    }
    return {
        
        'data': json['data'] == null ? undefined : ((json['data'] as Array<any>).map(AuctionBidFromJSON)),
        'metadata': json['metadata'] == null ? undefined : MilestonePaginatedResponse1MetadataFromJSON(json['metadata']),
    };
}

export function AuctionBidPaginatedResponse1ToJSON(json: any): AuctionBidPaginatedResponse1 {
    return AuctionBidPaginatedResponse1ToJSONTyped(json, false);
}

export function AuctionBidPaginatedResponse1ToJSONTyped(value?: AuctionBidPaginatedResponse1 | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': value['data'] == null ? undefined : ((value['data'] as Array<any>).map(AuctionBidToJSON)),
