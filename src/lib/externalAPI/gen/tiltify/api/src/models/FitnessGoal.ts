...
export interface FitnessGoal {
    /**
     * The Fitness Goal total amount
     * @type {string}
     * @memberof FitnessGoal
     */
    currentValue: string;
    /**
     * The Fitness Goal distance unit if it exists
     * @type {string}
     * @memberof FitnessGoal
     */
    distanceUnit: FitnessGoalDistanceUnitEnum | null;
    /**
     * The Fitness Goal goal amount
     * @type {string}
     * @memberof FitnessGoal
     */
    goal: string;
    /**
     * Unique Identifier for the fitness goal.
     * @type {string}
     * @memberof FitnessGoal
     */
    id: string;
    /**
     * The Fitness Goal Type
     * @type {string}
     * @memberof FitnessGoal
     */
    type: FitnessGoalTypeEnum;
}
 ...
 * @export
 */
export const FitnessGoalDistanceUnitEnum = {
    Meter: 'meter',
    Kilometer: 'kilometer',
    Mile: 'mile'
} as const;
export type FitnessGoalDistanceUnitEnum = typeof FitnessGoalDistanceUnitEnum[keyof typeof FitnessGoalDistanceUnitEnum];

/**
 * @export
 */
export const FitnessGoalTypeEnum = {
    Cycling: 'Cycling',
    Dancing: 'Dancing',
    Other: 'Other',
    Running: 'Running',
...
export type FitnessGoalTypeEnum = typeof FitnessGoalTypeEnum[keyof typeof FitnessGoalTypeEnum];


/**
 * Check if a given object implements the FitnessGoal interface.
 */
export function instanceOfFitnessGoal(value: object): value is FitnessGoal {
...
export function FitnessGoalFromJSON(json: any): FitnessGoal {
    return FitnessGoalFromJSONTyped(json, false);
}

export function FitnessGoalFromJSONTyped(json: any, ignoreDiscriminator: boolean): FitnessGoal {
    if (json == null) {
        return json;
    }
    return {
...
export function FitnessGoalToJSON(json: any): FitnessGoal {
    return FitnessGoalToJSONTyped(json, false);
}

export function FitnessGoalToJSONTyped(value?: FitnessGoal | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
