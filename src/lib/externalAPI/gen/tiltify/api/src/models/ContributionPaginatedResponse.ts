 ...
 * 
 * @export
 * @interface ContributionPaginatedResponse
 */
export interface ContributionPaginatedResponse {
    /**
     * 
     * @type {Array<Contribution>}
     * @memberof ContributionPaginatedResponse
     */
...
/**
 * Check if a given object implements the ContributionPaginatedResponse interface.
 */
export function instanceOfContributionPaginatedResponse(value: object): value is ContributionPaginatedResponse {
    return true;
}

export function ContributionPaginatedResponseFromJSON(json: any): ContributionPaginatedResponse {
    return ContributionPaginatedResponseFromJSONTyped(json, false);
}

export function ContributionPaginatedResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ContributionPaginatedResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function ContributionPaginatedResponseToJSON(json: any): ContributionPaginatedResponse {
    return ContributionPaginatedResponseToJSONTyped(json, false);
}

export function ContributionPaginatedResponseToJSONTyped(value?: ContributionPaginatedResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
