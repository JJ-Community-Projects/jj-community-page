...
export function instanceOfSocial(value: object): value is Social {
    ...
    if (!('snapchat' in value) || value['snapchat'] === undefined) return false;
    if (!('tiktok' in value) || value['tiktok'] === undefined) return false;
    if (!('twitch' in value) || value['twitch'] === undefined) return false;
    if (!('twitter' in value) || value['twitter'] === undefined) return false;
    if (!('website' in value) || value['website'] === undefined) return false;
    if (!('youtube' in value) || value['youtube'] === undefined) return false;
    return true;
}
