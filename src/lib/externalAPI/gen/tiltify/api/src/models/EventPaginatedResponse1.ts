 ...
 * 
 * @export
 * @interface EventPaginatedResponse1
 */
export interface EventPaginatedResponse1 {
    /**
     * 
     * @type {Array<Event>}
     * @memberof EventPaginatedResponse1
     */
    data?: Array<Event>;
    /**
     * 
...
/**
 * Check if a given object implements the EventPaginatedResponse1 interface.
 */
export function instanceOfEventPaginatedResponse1(value: object): value is EventPaginatedResponse1 {
    return true;
}

export function EventPaginatedResponse1FromJSON(json: any): EventPaginatedResponse1 {
    return EventPaginatedResponse1FromJSONTyped(json, false);
}

export function EventPaginatedResponse1FromJSONTyped(json: any, ignoreDiscriminator: boolean): EventPaginatedResponse1 {
    if (json == null) {
        return json;
    }
    return {
...
export function EventPaginatedResponse1ToJSON(json: any): EventPaginatedResponse1 {
    return EventPaginatedResponse1ToJSONTyped(json, false);
}

export function EventPaginatedResponse1ToJSONTyped(value?: EventPaginatedResponse1 | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
