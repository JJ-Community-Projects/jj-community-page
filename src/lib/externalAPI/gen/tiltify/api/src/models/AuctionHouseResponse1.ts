...
import {
    AuctionHouseFromJSON,
    AuctionHouseFromJSONTyped,
    AuctionHouseToJSON,
    AuctionHouseToJSONTyped,
} from './AuctionHouse';

/**
 * 
 * @export
 * @interface AuctionHouseResponse1
 */
export interface AuctionHouseResponse1 {
    /**
     * 
     * @type {AuctionHouse}
     * @memberof AuctionHouseResponse1
     */
    data?: AuctionHouse;
}

/**
 * Check if a given object implements the AuctionHouseResponse1 interface.
 */
export function instanceOfAuctionHouseResponse1(value: object): value is AuctionHouseResponse1 {
    return true;
}

export function AuctionHouseResponse1FromJSON(json: any): AuctionHouseResponse1 {
    return AuctionHouseResponse1FromJSONTyped(json, false);
}

export function AuctionHouseResponse1FromJSONTyped(json: any, ignoreDiscriminator: boolean): AuctionHouseResponse1 {
    if (json == null) {
        return json;
    }
    return {
        
        'data': json['data'] == null ? undefined : AuctionHouseFromJSON(json['data']),
    };
}

export function AuctionHouseResponse1ToJSON(json: any): AuctionHouseResponse1 {
    return AuctionHouseResponse1ToJSONTyped(json, false);
}

export function AuctionHouseResponse1ToJSONTyped(value?: AuctionHouseResponse1 | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': AuctionHouseToJSON(value['data']),
    };
}
