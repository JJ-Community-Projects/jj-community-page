 ...
 * @export
 * @interface TeamCampaignLivestream
 */
export interface TeamCampaignLivestream {
    /**
     * The channel name for the livestream
     * @type {string}
     * @memberof TeamCampaignLivestream
     */
    channel?: string | null;
    /**
...
/**
 * Check if a given object implements the TeamCampaignLivestream interface.
 */
export function instanceOfTeamCampaignLivestream(value: object): value is TeamCampaignLivestream {
    return true;
}

export function TeamCampaignLivestreamFromJSON(json: any): TeamCampaignLivestream {
    return TeamCampaignLivestreamFromJSONTyped(json, false);
}

export function TeamCampaignLivestreamFromJSONTyped(json: any, ignoreDiscriminator: boolean): TeamCampaignLivestream {
    if (json == null) {
        return json;
    }
    return {
...
export function TeamCampaignLivestreamToJSON(json: any): TeamCampaignLivestream {
    return TeamCampaignLivestreamToJSONTyped(json, false);
}

export function TeamCampaignLivestreamToJSONTyped(value?: TeamCampaignLivestream | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
