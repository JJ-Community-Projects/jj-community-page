...
import type { LegacyRelay } from './LegacyRelay';
import {
    LegacyRelayFromJSON,
    LegacyRelayFromJSONTyped,
    LegacyRelayToJSON,
    LegacyRelayToJSONTyped,
} from './LegacyRelay';

/**
 * 
 * @export
 * @interface LegacyRelayResponse1
 */
export interface LegacyRelayResponse1 {
    /**
     * 
     * @type {LegacyRelay}
     * @memberof LegacyRelayResponse1
     * @deprecated
     */
    data?: LegacyRelay;
}
...
/**
 * Check if a given object implements the LegacyRelayResponse1 interface.
 */
export function instanceOfLegacyRelayResponse1(value: object): value is LegacyRelayResponse1 {
    return true;
}

export function LegacyRelayResponse1FromJSON(json: any): LegacyRelayResponse1 {
    return LegacyRelayResponse1FromJSONTyped(json, false);
}

export function LegacyRelayResponse1FromJSONTyped(json: any, ignoreDiscriminator: boolean): LegacyRelayResponse1 {
    if (json == null) {
        return json;
    }
    return {
        
        'data': json['data'] == null ? undefined : LegacyRelayFromJSON(json['data']),
    };
}

export function LegacyRelayResponse1ToJSON(json: any): LegacyRelayResponse1 {
    return LegacyRelayResponse1ToJSONTyped(json, false);
}

export function LegacyRelayResponse1ToJSONTyped(value?: LegacyRelayResponse1 | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': LegacyRelayToJSON(value['data']),
    };
}
