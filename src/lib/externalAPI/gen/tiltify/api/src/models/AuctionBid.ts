...
export interface AuctionBid {
    ...
    amount: Money;
    /**
     * The ID for the auction house of this auction bid.
     * @type {string}
     * @memberof AuctionBid
     */
    auctionHouseId: string;
    /**
     * The ID for the auction item of this auction bid.
     * @type {string}
     * @memberof AuctionBid
     */
    auctionItemId: string;
    /**
     * Whether or not this bid is the current winning bid
     * @type {boolean}
     * @memberof AuctionBid
     */
    ...
    id: string;
    /**
     * When the auction bid was created
     * @type {Date}
     * @memberof AuctionBid
     */
    insertedAt: Date | null;
    /**
     * The public name of the bidder
     * @type {string}
     * @memberof AuctionBid
     */
    publicName: string;
    /**
     * When the auction bid was removed
     * @type {Date}
     * @memberof AuctionBid
     */
    removedAt: Date | null;
    /**
     * When the auction bid was updated
     * @type {Date}
     * @memberof AuctionBid
     */
    updatedAt: Date | null;
...
/**
 * Check if a given object implements the AuctionBid interface.
 */
export function instanceOfAuctionBid(value: object): value is AuctionBid {
    if (!('amount' in value) || value['amount'] === undefined) return false;
    if (!('auctionHouseId' in value) || value['auctionHouseId'] === undefined) return false;
    if (!('auctionItemId' in value) || value['auctionItemId'] === undefined) return false;
    if (!('currentWinner' in value) || value['currentWinner'] === undefined) return false;
...
export function AuctionBidFromJSON(json: any): AuctionBid {
    return AuctionBidFromJSONTyped(json, false);
}

export function AuctionBidFromJSONTyped(json: any, ignoreDiscriminator: boolean): AuctionBid {
    if (json == null) {
        return json;
    }
    return {
        ...
        'auctionHouseId': json['auction_house_id'],
        'auctionItemId': json['auction_item_id'],
        'currentWinner': json['current_winner'],
        'id': json['id'],
        'insertedAt': (json['inserted_at'] == null ? null : new Date(json['inserted_at'])),
        'publicName': json['public_name'],
        'removedAt': (json['removed_at'] == null ? null : new Date(json['removed_at'])),
        'updatedAt': (json['updated_at'] == null ? null : new Date(json['updated_at'])),
    };
}

export function AuctionBidToJSON(json: any): AuctionBid {
    return AuctionBidToJSONTyped(json, false);
}

export function AuctionBidToJSONTyped(value?: AuctionBid | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'auction_house_id': value['auctionHouseId'],
        'auction_item_id': value['auctionItemId'],
        'current_winner': value['currentWinner'],
        'id': value['id'],
        'inserted_at': (value['insertedAt'] == null ? null : (value['insertedAt'] as any).toISOString()),
        'public_name': value['publicName'],
        'removed_at': (value['removedAt'] == null ? null : (value['removedAt'] as any).toISOString()),
