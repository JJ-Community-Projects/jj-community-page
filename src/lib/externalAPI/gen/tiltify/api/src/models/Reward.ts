...
export interface Reward {
    ...
    active: boolean;
    /**
     * Amount needed to claim this reward
     * @type {Money}
     * @memberof Reward
     */
    amount: Money | null;
    ...
    endsAt: Date | null;
    /**
     * The fair market value of this reward
     * @type {Money}
     * @memberof Reward
     */
...
export function RewardToJSONTyped(value?: Reward | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'ends_at': (value['endsAt'] == null ? null : (value['endsAt'] as any).toISOString()),
        ...
        'starts_at': (value['startsAt'] == null ? null : (value['startsAt'] as any).toISOString()),
