...
export interface AuctionHouseResponse {
     ...
     * 
     * @type {AuctionHouse}
     * @memberof AuctionHouseResponse
     */
    data?: AuctionHouse;
}

/**
 * Check if a given object implements the AuctionHouseResponse interface.
 */
export function instanceOfAuctionHouseResponse(value: object): value is AuctionHouseResponse {
    return true;
}

export function AuctionHouseResponseFromJSON(json: any): AuctionHouseResponse {
    return AuctionHouseResponseFromJSONTyped(json, false);
}

export function AuctionHouseResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): AuctionHouseResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function AuctionHouseResponseToJSON(json: any): AuctionHouseResponse {
    return AuctionHouseResponseToJSONTyped(json, false);
}

export function AuctionHouseResponseToJSONTyped(value?: AuctionHouseResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
