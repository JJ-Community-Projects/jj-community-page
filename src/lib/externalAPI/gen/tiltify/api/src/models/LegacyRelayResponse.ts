 ...
 * 
 * @export
 * @interface LegacyRelayResponse
 */
export interface LegacyRelayResponse {
    /**
     * 
     * @type {LegacyRelay}
     * @memberof LegacyRelayResponse
     * @deprecated
     */
    data?: LegacyRelay;
}
...
/**
 * Check if a given object implements the LegacyRelayResponse interface.
 */
export function instanceOfLegacyRelayResponse(value: object): value is LegacyRelayResponse {
    return true;
}

export function LegacyRelayResponseFromJSON(json: any): LegacyRelayResponse {
    return LegacyRelayResponseFromJSONTyped(json, false);
}

export function LegacyRelayResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): LegacyRelayResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function LegacyRelayResponseToJSON(json: any): LegacyRelayResponse {
    return LegacyRelayResponseToJSONTyped(json, false);
}

export function LegacyRelayResponseToJSONTyped(value?: LegacyRelayResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
