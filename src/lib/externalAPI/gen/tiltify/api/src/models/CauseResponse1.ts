 ...
 * 
 * @export
 * @interface CauseResponse1
 */
export interface CauseResponse1 {
    /**
     * 
     * @type {Cause}
     * @memberof CauseResponse1
     */
    data?: Cause;
}

/**
 * Check if a given object implements the CauseResponse1 interface.
 */
export function instanceOfCauseResponse1(value: object): value is CauseResponse1 {
    return true;
}

export function CauseResponse1FromJSON(json: any): CauseResponse1 {
    return CauseResponse1FromJSONTyped(json, false);
}

export function CauseResponse1FromJSONTyped(json: any, ignoreDiscriminator: boolean): CauseResponse1 {
    if (json == null) {
        return json;
    }
    return {
        
        'data': json['data'] == null ? undefined : CauseFromJSON(json['data']),
    };
}

export function CauseResponse1ToJSON(json: any): CauseResponse1 {
    return CauseResponse1ToJSONTyped(json, false);
}

export function CauseResponse1ToJSONTyped(value?: CauseResponse1 | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
