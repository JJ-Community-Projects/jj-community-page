 ...
 * 
 * @export
 * @interface DonationPaginatedResponse1
 */
export interface DonationPaginatedResponse1 {
    /**
     * 
     * @type {Array<Donation>}
     * @memberof DonationPaginatedResponse1
     */
    data?: Array<Donation>;
    /**
     * 
...
/**
 * Check if a given object implements the DonationPaginatedResponse1 interface.
 */
export function instanceOfDonationPaginatedResponse1(value: object): value is DonationPaginatedResponse1 {
    return true;
}

export function DonationPaginatedResponse1FromJSON(json: any): DonationPaginatedResponse1 {
    return DonationPaginatedResponse1FromJSONTyped(json, false);
}

export function DonationPaginatedResponse1FromJSONTyped(json: any, ignoreDiscriminator: boolean): DonationPaginatedResponse1 {
    if (json == null) {
        return json;
    }
    return {
        
        'data': json['data'] == null ? undefined : ((json['data'] as Array<any>).map(DonationFromJSON)),
        'metadata': json['metadata'] == null ? undefined : MilestonePaginatedResponse1MetadataFromJSON(json['metadata']),
    };
}

export function DonationPaginatedResponse1ToJSON(json: any): DonationPaginatedResponse1 {
    return DonationPaginatedResponse1ToJSONTyped(json, false);
}

export function DonationPaginatedResponse1ToJSONTyped(value?: DonationPaginatedResponse1 | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': value['data'] == null ? undefined : ((value['data'] as Array<any>).map(DonationToJSON)),
