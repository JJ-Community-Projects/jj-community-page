 ...
 * 
 * @export
 * @interface PollPaginatedResponse1
 */
export interface PollPaginatedResponse1 {
    /**
     * 
     * @type {Array<Poll>}
     * @memberof PollPaginatedResponse1
     */
    data?: Array<Poll>;
    /**
     * 
...
/**
 * Check if a given object implements the PollPaginatedResponse1 interface.
 */
export function instanceOfPollPaginatedResponse1(value: object): value is PollPaginatedResponse1 {
    return true;
}

export function PollPaginatedResponse1FromJSON(json: any): PollPaginatedResponse1 {
    return PollPaginatedResponse1FromJSONTyped(json, false);
}

export function PollPaginatedResponse1FromJSONTyped(json: any, ignoreDiscriminator: boolean): PollPaginatedResponse1 {
    if (json == null) {
        return json;
    }
    return {
        
        'data': json['data'] == null ? undefined : ((json['data'] as Array<any>).map(PollFromJSON)),
        'metadata': json['metadata'] == null ? undefined : MilestonePaginatedResponse1MetadataFromJSON(json['metadata']),
    };
}

export function PollPaginatedResponse1ToJSON(json: any): PollPaginatedResponse1 {
    return PollPaginatedResponse1ToJSONTyped(json, false);
}

export function PollPaginatedResponse1ToJSONTyped(value?: PollPaginatedResponse1 | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': value['data'] == null ? undefined : ((value['data'] as Array<any>).map(PollToJSON)),
