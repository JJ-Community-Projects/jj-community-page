 ...
 * 
 * @export
 * @interface TeamPaginatedResponse1
 */
export interface TeamPaginatedResponse1 {
    /**
     * 
     * @type {Array<Team>}
     * @memberof TeamPaginatedResponse1
     */
    data?: Array<Team>;
    /**
     * 
...
/**
 * Check if a given object implements the TeamPaginatedResponse1 interface.
 */
export function instanceOfTeamPaginatedResponse1(value: object): value is TeamPaginatedResponse1 {
    return true;
}

export function TeamPaginatedResponse1FromJSON(json: any): TeamPaginatedResponse1 {
    return TeamPaginatedResponse1FromJSONTyped(json, false);
}

export function TeamPaginatedResponse1FromJSONTyped(json: any, ignoreDiscriminator: boolean): TeamPaginatedResponse1 {
    if (json == null) {
        return json;
    }
    return {
...
export function TeamPaginatedResponse1ToJSON(json: any): TeamPaginatedResponse1 {
    return TeamPaginatedResponse1ToJSONTyped(json, false);
}

export function TeamPaginatedResponse1ToJSONTyped(value?: TeamPaginatedResponse1 | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
