 ...
 * 
 * @export
 * @interface TeamCampaignResponse1
 */
export interface TeamCampaignResponse1 {
    /**
     * 
     * @type {TeamCampaign}
     * @memberof TeamCampaignResponse1
     */
    data?: TeamCampaign;
}

/**
 * Check if a given object implements the TeamCampaignResponse1 interface.
 */
export function instanceOfTeamCampaignResponse1(value: object): value is TeamCampaignResponse1 {
    return true;
}

export function TeamCampaignResponse1FromJSON(json: any): TeamCampaignResponse1 {
    return TeamCampaignResponse1FromJSONTyped(json, false);
}

export function TeamCampaignResponse1FromJSONTyped(json: any, ignoreDiscriminator: boolean): TeamCampaignResponse1 {
    if (json == null) {
        return json;
    }
    return {
        
        'data': json['data'] == null ? undefined : TeamCampaignFromJSON(json['data']),
    };
}

export function TeamCampaignResponse1ToJSON(json: any): TeamCampaignResponse1 {
    return TeamCampaignResponse1ToJSONTyped(json, false);
}

export function TeamCampaignResponse1ToJSONTyped(value?: TeamCampaignResponse1 | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': TeamCampaignToJSON(value['data']),
    };
}
