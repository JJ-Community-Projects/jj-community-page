 ...
 * 
 * @export
 * @interface PersonalCampaignPaginatedResponse
 */
export interface PersonalCampaignPaginatedResponse {
    /**
     * 
     * @type {Array<PersonalCampaign>}
     * @memberof PersonalCampaignPaginatedResponse
     */
...
/**
 * Check if a given object implements the PersonalCampaignPaginatedResponse interface.
 */
export function instanceOfPersonalCampaignPaginatedResponse(value: object): value is PersonalCampaignPaginatedResponse {
    return true;
}

export function PersonalCampaignPaginatedResponseFromJSON(json: any): PersonalCampaignPaginatedResponse {
    return PersonalCampaignPaginatedResponseFromJSONTyped(json, false);
}

export function PersonalCampaignPaginatedResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): PersonalCampaignPaginatedResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function PersonalCampaignPaginatedResponseToJSON(json: any): PersonalCampaignPaginatedResponse {
    return PersonalCampaignPaginatedResponseToJSONTyped(json, false);
}

export function PersonalCampaignPaginatedResponseToJSONTyped(value?: PersonalCampaignPaginatedResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
