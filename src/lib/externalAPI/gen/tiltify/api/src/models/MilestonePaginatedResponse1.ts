 ...
 * 
 * @export
 * @interface MilestonePaginatedResponse1
 */
export interface MilestonePaginatedResponse1 {
    /**
     * 
     * @type {Array<Milestone>}
     * @memberof MilestonePaginatedResponse1
     */
...
/**
 * Check if a given object implements the MilestonePaginatedResponse1 interface.
 */
export function instanceOfMilestonePaginatedResponse1(value: object): value is MilestonePaginatedResponse1 {
    return true;
}

export function MilestonePaginatedResponse1FromJSON(json: any): MilestonePaginatedResponse1 {
    return MilestonePaginatedResponse1FromJSONTyped(json, false);
}

export function MilestonePaginatedResponse1FromJSONTyped(json: any, ignoreDiscriminator: boolean): MilestonePaginatedResponse1 {
    if (json == null) {
        return json;
    }
    return {
        
        'data': json['data'] == null ? undefined : ((json['data'] as Array<any>).map(MilestoneFromJSON)),
        'metadata': json['metadata'] == null ? undefined : MilestonePaginatedResponse1MetadataFromJSON(json['metadata']),
    };
}

export function MilestonePaginatedResponse1ToJSON(json: any): MilestonePaginatedResponse1 {
    return MilestonePaginatedResponse1ToJSONTyped(json, false);
}

export function MilestonePaginatedResponse1ToJSONTyped(value?: MilestonePaginatedResponse1 | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': value['data'] == null ? undefined : ((value['data'] as Array<any>).map(MilestoneToJSON)),
