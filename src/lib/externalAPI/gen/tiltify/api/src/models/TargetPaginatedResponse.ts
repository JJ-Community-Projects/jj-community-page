 ...
 * 
 * @export
 * @interface TargetPaginatedResponse
 */
export interface TargetPaginatedResponse {
    /**
     * 
     * @type {Array<Target>}
     * @memberof TargetPaginatedResponse
     */
    data?: Array<Target>;
    /**
     * 
...
/**
 * Check if a given object implements the TargetPaginatedResponse interface.
 */
export function instanceOfTargetPaginatedResponse(value: object): value is TargetPaginatedResponse {
    return true;
}

export function TargetPaginatedResponseFromJSON(json: any): TargetPaginatedResponse {
    return TargetPaginatedResponseFromJSONTyped(json, false);
}

export function TargetPaginatedResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): TargetPaginatedResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function TargetPaginatedResponseToJSON(json: any): TargetPaginatedResponse {
    return TargetPaginatedResponseToJSONTyped(json, false);
}

export function TargetPaginatedResponseToJSONTyped(value?: TargetPaginatedResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
