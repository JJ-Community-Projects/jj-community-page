 ...
 * 
 * @export
 * @interface TeamResponse1
 */
export interface TeamResponse1 {
    /**
     * 
     * @type {Team}
     * @memberof TeamResponse1
     */
    data?: Team;
}

/**
 * Check if a given object implements the TeamResponse1 interface.
 */
export function instanceOfTeamResponse1(value: object): value is TeamResponse1 {
    return true;
}

export function TeamResponse1FromJSON(json: any): TeamResponse1 {
    return TeamResponse1FromJSONTyped(json, false);
}

export function TeamResponse1FromJSONTyped(json: any, ignoreDiscriminator: boolean): TeamResponse1 {
    if (json == null) {
        return json;
    }
    return {
...
export function TeamResponse1ToJSON(json: any): TeamResponse1 {
    return TeamResponse1ToJSONTyped(json, false);
}

export function TeamResponse1ToJSONTyped(value?: TeamResponse1 | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
