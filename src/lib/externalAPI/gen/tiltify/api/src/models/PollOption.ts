...
export interface PollOption {
    /**
     * Amount Raised by this poll option
     * @type {Money}
     * @memberof PollOption
     */
    ...
    id: string;
    /**
     * Moment when the poll option was created
     * @type {Date}
     * @memberof PollOption
     */
    insertedAt: Date;
    ...
    name: string;
    /**
     * Moment when the poll option was last updated
     * @type {Date}
     * @memberof PollOption
     */
    updatedAt: Date;
 ...
 */
export function instanceOfPollOption(value: object): value is PollOption {
...
export function PollOptionToJSON(json: any): PollOption {
    return PollOptionToJSONTyped(json, false);
}

export function PollOptionToJSONTyped(value?: PollOption | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
