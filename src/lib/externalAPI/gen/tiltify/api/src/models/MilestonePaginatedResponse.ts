 ...
 * 
 * @export
 * @interface MilestonePaginatedResponse
 */
export interface MilestonePaginatedResponse {
    /**
     * 
     * @type {Array<Milestone>}
     * @memberof MilestonePaginatedResponse
     */
...
/**
 * Check if a given object implements the MilestonePaginatedResponse interface.
 */
export function instanceOfMilestonePaginatedResponse(value: object): value is MilestonePaginatedResponse {
    return true;
}

export function MilestonePaginatedResponseFromJSON(json: any): MilestonePaginatedResponse {
    return MilestonePaginatedResponseFromJSONTyped(json, false);
}

export function MilestonePaginatedResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): MilestonePaginatedResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function MilestonePaginatedResponseToJSON(json: any): MilestonePaginatedResponse {
    return MilestonePaginatedResponseToJSONTyped(json, false);
}

export function MilestonePaginatedResponseToJSONTyped(value?: MilestonePaginatedResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
