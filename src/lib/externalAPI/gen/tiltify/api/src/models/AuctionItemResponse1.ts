 ...
 * 
 * @export
 * @interface AuctionItemResponse1
 */
export interface AuctionItemResponse1 {
    /**
     * 
     * @type {AuctionItem}
     * @memberof AuctionItemResponse1
     */
    data?: AuctionItem;
}

/**
 * Check if a given object implements the AuctionItemResponse1 interface.
 */
export function instanceOfAuctionItemResponse1(value: object): value is AuctionItemResponse1 {
    return true;
}

export function AuctionItemResponse1FromJSON(json: any): AuctionItemResponse1 {
    return AuctionItemResponse1FromJSONTyped(json, false);
}

export function AuctionItemResponse1FromJSONTyped(json: any, ignoreDiscriminator: boolean): AuctionItemResponse1 {
    if (json == null) {
        return json;
    }
    return {
        
        'data': json['data'] == null ? undefined : AuctionItemFromJSON(json['data']),
    };
}

export function AuctionItemResponse1ToJSON(json: any): AuctionItemResponse1 {
    return AuctionItemResponse1ToJSONTyped(json, false);
}

export function AuctionItemResponse1ToJSONTyped(value?: AuctionItemResponse1 | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': AuctionItemToJSON(value['data']),
    };
}
