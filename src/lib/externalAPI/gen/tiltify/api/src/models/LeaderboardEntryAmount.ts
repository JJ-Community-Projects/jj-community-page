...
import type { MeasuredUnit } from './MeasuredUnit';
import {
    instanceOfMeasuredUnit,
    MeasuredUnitFromJSON,
    MeasuredUnitFromJSONTyped,
    MeasuredUnitToJSON,
} from './MeasuredUnit';
...
/**
 * @type LeaderboardEntryAmount
 * The total amount raised by this leaderboard entry.
 * @export
 */
export type LeaderboardEntryAmount = MeasuredUnit | Money;

export function LeaderboardEntryAmountFromJSON(json: any): LeaderboardEntryAmount {
    return LeaderboardEntryAmountFromJSONTyped(json, false);
}

export function LeaderboardEntryAmountFromJSONTyped(json: any, ignoreDiscriminator: boolean): LeaderboardEntryAmount {
    if (json == null) {
        return json;
    }
    ...
    if (instanceOfMeasuredUnit(json)) {
        return MeasuredUnitFromJSONTyped(json, true);
    }
...
export function LeaderboardEntryAmountToJSON(json: any): any {
    return LeaderboardEntryAmountToJSONTyped(json, false);
}

export function LeaderboardEntryAmountToJSONTyped(value?: LeaderboardEntryAmount | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    if (instanceOfMeasuredUnit(value)) {
        return MeasuredUnitToJSON(value as MeasuredUnit);
    }
