 ...
 * 
 * @export
 * @interface CampaignPaginatedResponse1
 */
export interface CampaignPaginatedResponse1 {
    /**
     * 
     * @type {Array<Campaign>}
     * @memberof CampaignPaginatedResponse1
     */
    data?: Array<Campaign>;
    /**
     * 
...
/**
 * Check if a given object implements the CampaignPaginatedResponse1 interface.
 */
export function instanceOfCampaignPaginatedResponse1(value: object): value is CampaignPaginatedResponse1 {
    return true;
}

export function CampaignPaginatedResponse1FromJSON(json: any): CampaignPaginatedResponse1 {
    return CampaignPaginatedResponse1FromJSONTyped(json, false);
}

export function CampaignPaginatedResponse1FromJSONTyped(json: any, ignoreDiscriminator: boolean): CampaignPaginatedResponse1 {
    if (json == null) {
        return json;
    }
    return {
        
        'data': json['data'] == null ? undefined : ((json['data'] as Array<any>).map(CampaignFromJSON)),
        'metadata': json['metadata'] == null ? undefined : MilestonePaginatedResponse1MetadataFromJSON(json['metadata']),
    };
}

export function CampaignPaginatedResponse1ToJSON(json: any): CampaignPaginatedResponse1 {
    return CampaignPaginatedResponse1ToJSONTyped(json, false);
}

export function CampaignPaginatedResponse1ToJSONTyped(value?: CampaignPaginatedResponse1 | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
