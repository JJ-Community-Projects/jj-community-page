...
export interface GiftMatch {
    ...
    active: boolean;
    /**
     * The amount of the donation match.
     * @type {Money}
     * @memberof GiftMatch
     */
    amount: Money;
    ...
    /**
     * Unique Identifier for the donation matches contribution.
     * @type {string}
     * @memberof GiftMatch
     */
    ...
    endsAt: Date;
    /**
     * Unique Identifier for the donation match.
     * @type {string}
     * @memberof GiftMatch
     */
    id: string;
    ...
    matchedBy: string;
    /**
     * The amount the donation match has pledged.
     * @type {Money}
     * @memberof GiftMatch
     */
    pledgedAmount: Money;
    /**
     * The amount raised the campaign had when the donation match was started.
     * @type {Money}
     * @memberof GiftMatch
     */
    startedAtAmount: Money;
    /**
    ...
    startsAt: Date;
    /**
     * The amount the donation match has raised.
     * @type {Money}
     * @memberof GiftMatch
     */
...
/**
 * Check if a given object implements the GiftMatch interface.
 */
export function instanceOfGiftMatch(value: object): value is GiftMatch {
    if (!('active' in value) || value['active'] === undefined) return false;
    if (!('amount' in value) || value['amount'] === undefined) return false;
    if (!('completedAt' in value) || value['completedAt'] === undefined) return false;
    if (!('contributionId' in value) || value['contributionId'] === undefined) return false;
    ...
    if (!('matchedBy' in value) || value['matchedBy'] === undefined) return false;
    if (!('pledgedAmount' in value) || value['pledgedAmount'] === undefined) return false;
    if (!('startedAtAmount' in value) || value['startedAtAmount'] === undefined) return false;
...
export function GiftMatchFromJSON(json: any): GiftMatch {
    return GiftMatchFromJSONTyped(json, false);
}

export function GiftMatchFromJSONTyped(json: any, ignoreDiscriminator: boolean): GiftMatch {
    if (json == null) {
        return json;
    }
    return {
        ...
        'pledgedAmount': MoneyFromJSON(json['pledged_amount']),
        'startedAtAmount': MoneyFromJSON(json['started_at_amount']),
...
export function GiftMatchToJSON(json: any): GiftMatch {
    return GiftMatchToJSONTyped(json, false);
}

export function GiftMatchToJSONTyped(value?: GiftMatch | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'pledged_amount': MoneyToJSON(value['pledgedAmount']),
        'started_at_amount': MoneyToJSON(value['startedAtAmount']),
