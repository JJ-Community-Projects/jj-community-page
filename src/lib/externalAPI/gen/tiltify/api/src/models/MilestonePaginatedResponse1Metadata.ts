 ...
 * 
 * @export
 * @interface MilestonePaginatedResponse1Metadata
 */
export interface MilestonePaginatedResponse1Metadata {
    /**
     * The cursor to the next page if it exists
     * @type {string}
     * @memberof MilestonePaginatedResponse1Metadata
     */
    after: string | null;
    /**
     * The cursor to the previous page if it exists
     * @type {string}
     * @memberof MilestonePaginatedResponse1Metadata
     */
    before: string | null;
...
/**
 * Check if a given object implements the MilestonePaginatedResponse1Metadata interface.
 */
export function instanceOfMilestonePaginatedResponse1Metadata(value: object): value is MilestonePaginatedResponse1Metadata {
...
export function MilestonePaginatedResponse1MetadataFromJSON(json: any): MilestonePaginatedResponse1Metadata {
    return MilestonePaginatedResponse1MetadataFromJSONTyped(json, false);
}

export function MilestonePaginatedResponse1MetadataFromJSONTyped(json: any, ignoreDiscriminator: boolean): MilestonePaginatedResponse1Metadata {
    if (json == null) {
        return json;
    }
    return {
...
export function MilestonePaginatedResponse1MetadataToJSON(json: any): MilestonePaginatedResponse1Metadata {
    return MilestonePaginatedResponse1MetadataToJSONTyped(json, false);
}

export function MilestonePaginatedResponse1MetadataToJSONTyped(value?: MilestonePaginatedResponse1Metadata | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
