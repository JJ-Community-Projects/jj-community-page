...
import {
    FitnessGoalFromJSON,
    FitnessGoalFromJSONTyped,
    FitnessGoalToJSON,
    FitnessGoalToJSONTyped,
} from './FitnessGoal';

/**
 * 
 * @export
 * @interface FitnessGoalPaginatedResponse1
 */
export interface FitnessGoalPaginatedResponse1 {
    /**
     * 
     * @type {Array<FitnessGoal>}
     * @memberof FitnessGoalPaginatedResponse1
     */
    data?: Array<FitnessGoal>;
    /**
     * 
...
/**
 * Check if a given object implements the FitnessGoalPaginatedResponse1 interface.
 */
export function instanceOfFitnessGoalPaginatedResponse1(value: object): value is FitnessGoalPaginatedResponse1 {
    return true;
}

export function FitnessGoalPaginatedResponse1FromJSON(json: any): FitnessGoalPaginatedResponse1 {
    return FitnessGoalPaginatedResponse1FromJSONTyped(json, false);
}

export function FitnessGoalPaginatedResponse1FromJSONTyped(json: any, ignoreDiscriminator: boolean): FitnessGoalPaginatedResponse1 {
    if (json == null) {
        return json;
    }
    return {
        
        'data': json['data'] == null ? undefined : ((json['data'] as Array<any>).map(FitnessGoalFromJSON)),
        'metadata': json['metadata'] == null ? undefined : MilestonePaginatedResponse1MetadataFromJSON(json['metadata']),
    };
}

export function FitnessGoalPaginatedResponse1ToJSON(json: any): FitnessGoalPaginatedResponse1 {
    return FitnessGoalPaginatedResponse1ToJSONTyped(json, false);
}

export function FitnessGoalPaginatedResponse1ToJSONTyped(value?: FitnessGoalPaginatedResponse1 | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': value['data'] == null ? undefined : ((value['data'] as Array<any>).map(FitnessGoalToJSON)),
