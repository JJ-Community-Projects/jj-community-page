...
export interface SchedulePaginatedResponse {
     ...
     * 
     * @type {Array<Schedule>}
     * @memberof SchedulePaginatedResponse
     */
    data?: Array<Schedule>;
    /**
     * 
...
/**
 * Check if a given object implements the SchedulePaginatedResponse interface.
 */
export function instanceOfSchedulePaginatedResponse(value: object): value is SchedulePaginatedResponse {
    return true;
}

export function SchedulePaginatedResponseFromJSON(json: any): SchedulePaginatedResponse {
    return SchedulePaginatedResponseFromJSONTyped(json, false);
}

export function SchedulePaginatedResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): SchedulePaginatedResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function SchedulePaginatedResponseToJSON(json: any): SchedulePaginatedResponse {
    return SchedulePaginatedResponseToJSONTyped(json, false);
}

export function SchedulePaginatedResponseToJSONTyped(value?: SchedulePaginatedResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
