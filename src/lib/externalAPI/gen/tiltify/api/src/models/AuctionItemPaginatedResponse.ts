 ...
 * 
 * @export
 * @interface AuctionItemPaginatedResponse
 */
export interface AuctionItemPaginatedResponse {
    /**
     * 
     * @type {Array<AuctionItem>}
     * @memberof AuctionItemPaginatedResponse
     */
...
/**
 * Check if a given object implements the AuctionItemPaginatedResponse interface.
 */
export function instanceOfAuctionItemPaginatedResponse(value: object): value is AuctionItemPaginatedResponse {
    return true;
}

export function AuctionItemPaginatedResponseFromJSON(json: any): AuctionItemPaginatedResponse {
    return AuctionItemPaginatedResponseFromJSONTyped(json, false);
}

export function AuctionItemPaginatedResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): AuctionItemPaginatedResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function AuctionItemPaginatedResponseToJSON(json: any): AuctionItemPaginatedResponse {
    return AuctionItemPaginatedResponseToJSONTyped(json, false);
}

export function AuctionItemPaginatedResponseToJSONTyped(value?: AuctionItemPaginatedResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
