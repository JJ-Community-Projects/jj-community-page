...
export interface AuctionItemResponse {
     ...
     * 
     * @type {AuctionItem}
     * @memberof AuctionItemResponse
     */
    data?: AuctionItem;
}

/**
 * Check if a given object implements the AuctionItemResponse interface.
 */
export function instanceOfAuctionItemResponse(value: object): value is AuctionItemResponse {
    return true;
}

export function AuctionItemResponseFromJSON(json: any): AuctionItemResponse {
    return AuctionItemResponseFromJSONTyped(json, false);
}

export function AuctionItemResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): AuctionItemResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function AuctionItemResponseToJSON(json: any): AuctionItemResponse {
    return AuctionItemResponseToJSONTyped(json, false);
}

export function AuctionItemResponseToJSONTyped(value?: AuctionItemResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
