 ...
 * 
 * @export
 * @interface CampaignResponse1
 */
export interface CampaignResponse1 {
    /**
     * 
     * @type {Campaign}
     * @memberof CampaignResponse1
     */
    data?: Campaign;
}

/**
 * Check if a given object implements the CampaignResponse1 interface.
 */
export function instanceOfCampaignResponse1(value: object): value is CampaignResponse1 {
    return true;
}

export function CampaignResponse1FromJSON(json: any): CampaignResponse1 {
    return CampaignResponse1FromJSONTyped(json, false);
}

export function CampaignResponse1FromJSONTyped(json: any, ignoreDiscriminator: boolean): CampaignResponse1 {
    if (json == null) {
        return json;
    }
    return {
        
        'data': json['data'] == null ? undefined : CampaignFromJSON(json['data']),
    };
}

export function CampaignResponse1ToJSON(json: any): CampaignResponse1 {
    return CampaignResponse1ToJSONTyped(json, false);
}

export function CampaignResponse1ToJSONTyped(value?: CampaignResponse1 | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': CampaignToJSON(value['data']),
    };
}
