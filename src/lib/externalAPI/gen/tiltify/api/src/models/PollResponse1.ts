 ...
 * 
 * @export
 * @interface PollResponse1
 */
export interface PollResponse1 {
    /**
     * 
     * @type {Poll}
     * @memberof PollResponse1
     */
    data?: Poll;
}

/**
 * Check if a given object implements the PollResponse1 interface.
 */
export function instanceOfPollResponse1(value: object): value is PollResponse1 {
    return true;
}

export function PollResponse1FromJSON(json: any): PollResponse1 {
    return PollResponse1FromJSONTyped(json, false);
}

export function PollResponse1FromJSONTyped(json: any, ignoreDiscriminator: boolean): PollResponse1 {
    if (json == null) {
        return json;
    }
    return {
        
        'data': json['data'] == null ? undefined : PollFromJSON(json['data']),
    };
}

export function PollResponse1ToJSON(json: any): PollResponse1 {
    return PollResponse1ToJSONTyped(json, false);
}

export function PollResponse1ToJSONTyped(value?: PollResponse1 | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
