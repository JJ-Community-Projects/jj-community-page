 ...
 * 
 * @export
 * @interface RewardPaginatedResponse
 */
export interface RewardPaginatedResponse {
    /**
     * 
     * @type {Array<Reward>}
     * @memberof RewardPaginatedResponse
     */
    data?: Array<Reward>;
    /**
     * 
...
/**
 * Check if a given object implements the RewardPaginatedResponse interface.
 */
export function instanceOfRewardPaginatedResponse(value: object): value is RewardPaginatedResponse {
    return true;
}

export function RewardPaginatedResponseFromJSON(json: any): RewardPaginatedResponse {
    return RewardPaginatedResponseFromJSONTyped(json, false);
}

export function RewardPaginatedResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): RewardPaginatedResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function RewardPaginatedResponseToJSON(json: any): RewardPaginatedResponse {
    return RewardPaginatedResponseToJSONTyped(json, false);
}

export function RewardPaginatedResponseToJSONTyped(value?: RewardPaginatedResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
