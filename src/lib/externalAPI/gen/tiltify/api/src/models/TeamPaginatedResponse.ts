 ...
 * 
 * @export
 * @interface TeamPaginatedResponse
 */
export interface TeamPaginatedResponse {
    /**
     * 
     * @type {Array<Team>}
     * @memberof TeamPaginatedResponse
     */
    data?: Array<Team>;
    /**
     * 
...
/**
 * Check if a given object implements the TeamPaginatedResponse interface.
 */
export function instanceOfTeamPaginatedResponse(value: object): value is TeamPaginatedResponse {
    return true;
}

export function TeamPaginatedResponseFromJSON(json: any): TeamPaginatedResponse {
    return TeamPaginatedResponseFromJSONTyped(json, false);
}

export function TeamPaginatedResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): TeamPaginatedResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function TeamPaginatedResponseToJSON(json: any): TeamPaginatedResponse {
    return TeamPaginatedResponseToJSONTyped(json, false);
}

export function TeamPaginatedResponseToJSONTyped(value?: TeamPaginatedResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
