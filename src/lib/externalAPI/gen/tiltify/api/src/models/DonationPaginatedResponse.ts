 ...
 * 
 * @export
 * @interface DonationPaginatedResponse
 */
export interface DonationPaginatedResponse {
    /**
     * 
     * @type {Array<Donation>}
     * @memberof DonationPaginatedResponse
     */
    data?: Array<Donation>;
    /**
     * 
...
/**
 * Check if a given object implements the DonationPaginatedResponse interface.
 */
export function instanceOfDonationPaginatedResponse(value: object): value is DonationPaginatedResponse {
    return true;
}

export function DonationPaginatedResponseFromJSON(json: any): DonationPaginatedResponse {
    return DonationPaginatedResponseFromJSONTyped(json, false);
}

export function DonationPaginatedResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): DonationPaginatedResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function DonationPaginatedResponseToJSON(json: any): DonationPaginatedResponse {
    return DonationPaginatedResponseToJSONTyped(json, false);
}

export function DonationPaginatedResponseToJSONTyped(value?: DonationPaginatedResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
