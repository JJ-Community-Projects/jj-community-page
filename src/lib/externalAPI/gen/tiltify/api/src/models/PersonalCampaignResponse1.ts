 ...
 * 
 * @export
 * @interface PersonalCampaignResponse1
 */
export interface PersonalCampaignResponse1 {
    /**
     * 
     * @type {PersonalCampaign}
     * @memberof PersonalCampaignResponse1
     */
    data?: PersonalCampaign;
}

/**
 * Check if a given object implements the PersonalCampaignResponse1 interface.
 */
export function instanceOfPersonalCampaignResponse1(value: object): value is PersonalCampaignResponse1 {
    return true;
}

export function PersonalCampaignResponse1FromJSON(json: any): PersonalCampaignResponse1 {
    return PersonalCampaignResponse1FromJSONTyped(json, false);
}

export function PersonalCampaignResponse1FromJSONTyped(json: any, ignoreDiscriminator: boolean): PersonalCampaignResponse1 {
    if (json == null) {
        return json;
    }
    return {
        
        'data': json['data'] == null ? undefined : PersonalCampaignFromJSON(json['data']),
    };
}

export function PersonalCampaignResponse1ToJSON(json: any): PersonalCampaignResponse1 {
    return PersonalCampaignResponse1ToJSONTyped(json, false);
}

export function PersonalCampaignResponse1ToJSONTyped(value?: PersonalCampaignResponse1 | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': PersonalCampaignToJSON(value['data']),
    };
}
