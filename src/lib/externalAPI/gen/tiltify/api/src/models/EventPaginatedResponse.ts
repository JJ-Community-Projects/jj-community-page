...
export interface EventPaginatedResponse {
     ...
     * 
     * @type {Array<Event>}
     * @memberof EventPaginatedResponse
     */
    data?: Array<Event>;
    /**
     * 
...
/**
 * Check if a given object implements the EventPaginatedResponse interface.
 */
export function instanceOfEventPaginatedResponse(value: object): value is EventPaginatedResponse {
    return true;
}

export function EventPaginatedResponseFromJSON(json: any): EventPaginatedResponse {
    return EventPaginatedResponseFromJSONTyped(json, false);
}

export function EventPaginatedResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): EventPaginatedResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function EventPaginatedResponseToJSON(json: any): EventPaginatedResponse {
    return EventPaginatedResponseToJSONTyped(json, false);
}

export function EventPaginatedResponseToJSONTyped(value?: EventPaginatedResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
