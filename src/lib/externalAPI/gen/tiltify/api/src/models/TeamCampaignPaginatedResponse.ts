 ...
 * 
 * @export
 * @interface TeamCampaignPaginatedResponse
 */
export interface TeamCampaignPaginatedResponse {
    /**
     * 
     * @type {Array<TeamCampaign>}
     * @memberof TeamCampaignPaginatedResponse
     */
...
/**
 * Check if a given object implements the TeamCampaignPaginatedResponse interface.
 */
export function instanceOfTeamCampaignPaginatedResponse(value: object): value is TeamCampaignPaginatedResponse {
    return true;
}

export function TeamCampaignPaginatedResponseFromJSON(json: any): TeamCampaignPaginatedResponse {
    return TeamCampaignPaginatedResponseFromJSONTyped(json, false);
}

export function TeamCampaignPaginatedResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): TeamCampaignPaginatedResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function TeamCampaignPaginatedResponseToJSON(json: any): TeamCampaignPaginatedResponse {
    return TeamCampaignPaginatedResponseToJSONTyped(json, false);
}

export function TeamCampaignPaginatedResponseToJSONTyped(value?: TeamCampaignPaginatedResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
