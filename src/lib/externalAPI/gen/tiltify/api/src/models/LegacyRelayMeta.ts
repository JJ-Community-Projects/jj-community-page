 ...
 * The providers metadata
 * @export
 */
export type LegacyRelayMeta = object | string;

export function LegacyRelayMetaFromJSON(json: any): LegacyRelayMeta {
    return LegacyRelayMetaFromJSONTyped(json, false);
}

export function LegacyRelayMetaFromJSONTyped(json: any, ignoreDiscriminator: boolean): LegacyRelayMeta {
    if (json == null) {
        return json;
    }
...
export function LegacyRelayMetaToJSON(json: any): any {
    return LegacyRelayMetaToJSONTyped(json, false);
}

export function LegacyRelayMetaToJSONTyped(value?: LegacyRelayMeta | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
