 ...
 * 
 * @export
 * @interface LeaderboardEntryPaginatedResponse1
 */
export interface LeaderboardEntryPaginatedResponse1 {
    /**
     * 
     * @type {Array<LeaderboardEntry>}
     * @memberof LeaderboardEntryPaginatedResponse1
     */
...
/**
 * Check if a given object implements the LeaderboardEntryPaginatedResponse1 interface.
 */
export function instanceOfLeaderboardEntryPaginatedResponse1(value: object): value is LeaderboardEntryPaginatedResponse1 {
    return true;
}

export function LeaderboardEntryPaginatedResponse1FromJSON(json: any): LeaderboardEntryPaginatedResponse1 {
    return LeaderboardEntryPaginatedResponse1FromJSONTyped(json, false);
}

export function LeaderboardEntryPaginatedResponse1FromJSONTyped(json: any, ignoreDiscriminator: boolean): LeaderboardEntryPaginatedResponse1 {
    if (json == null) {
        return json;
    }
    return {
        
        'data': json['data'] == null ? undefined : ((json['data'] as Array<any>).map(LeaderboardEntryFromJSON)),
        'metadata': json['metadata'] == null ? undefined : MilestonePaginatedResponse1MetadataFromJSON(json['metadata']),
    };
}

export function LeaderboardEntryPaginatedResponse1ToJSON(json: any): LeaderboardEntryPaginatedResponse1 {
    return LeaderboardEntryPaginatedResponse1ToJSONTyped(json, false);
}

export function LeaderboardEntryPaginatedResponse1ToJSONTyped(value?: LeaderboardEntryPaginatedResponse1 | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': value['data'] == null ? undefined : ((value['data'] as Array<any>).map(LeaderboardEntryToJSON)),
