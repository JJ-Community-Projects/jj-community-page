...
export interface Target {
    ...
    active: boolean;
    /**
     * Amount to hit this target
     * @type {Money}
     * @memberof Target
     */
    amount: Money | null;
    /**
     * Amount Raised by this target
     * @type {Money}
     * @memberof Target
     */
    amountRaised: Money | null;
    /**
     * Moment when the target ends
     * @type {Date}
     * @memberof Target
     */
    endsAt: Date;
    ...
    id: string;
    /**
     * Moment when the target was created
     * @type {Date}
     * @memberof Target
     */
    insertedAt: Date;
    ...
    name: string;
    /**
     * Moment when the target was last updated
     * @type {Date}
     * @memberof Target
     */
    updatedAt: Date;
