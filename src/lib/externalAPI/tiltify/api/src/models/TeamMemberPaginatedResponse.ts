 ...
 * 
 * @export
 * @interface TeamMemberPaginatedResponse
 */
export interface TeamMemberPaginatedResponse {
    /**
     * 
     * @type {Array<TeamMember>}
     * @memberof TeamMemberPaginatedResponse
     */
...
/**
 * Check if a given object implements the TeamMemberPaginatedResponse interface.
 */
export function instanceOfTeamMemberPaginatedResponse(value: object): value is TeamMemberPaginatedResponse {
    return true;
}

export function TeamMemberPaginatedResponseFromJSON(json: any): TeamMemberPaginatedResponse {
    return TeamMemberPaginatedResponseFromJSONTyped(json, false);
}

export function TeamMemberPaginatedResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): TeamMemberPaginatedResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function TeamMemberPaginatedResponseToJSON(json: any): TeamMemberPaginatedResponse {
    return TeamMemberPaginatedResponseToJSONTyped(json, false);
}

export function TeamMemberPaginatedResponseToJSONTyped(value?: TeamMemberPaginatedResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
