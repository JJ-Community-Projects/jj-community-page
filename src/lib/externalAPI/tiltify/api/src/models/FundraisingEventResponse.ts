 ...
 * 
 * @export
 * @interface FundraisingEventResponse
 */
export interface FundraisingEventResponse {
    /**
     * 
     * @type {FundraisingEvent}
     * @memberof FundraisingEventResponse
     */
    data?: FundraisingEvent;
}

/**
 * Check if a given object implements the FundraisingEventResponse interface.
 */
export function instanceOfFundraisingEventResponse(value: object): value is FundraisingEventResponse {
    return true;
}

export function FundraisingEventResponseFromJSON(json: any): FundraisingEventResponse {
    return FundraisingEventResponseFromJSONTyped(json, false);
}

export function FundraisingEventResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): FundraisingEventResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function FundraisingEventResponseToJSON(json: any): FundraisingEventResponse {
    return FundraisingEventResponseToJSONTyped(json, false);
}

export function FundraisingEventResponseToJSONTyped(value?: FundraisingEventResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
