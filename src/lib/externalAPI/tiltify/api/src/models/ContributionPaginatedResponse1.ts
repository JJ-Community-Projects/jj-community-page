...
import {
    ...
    ContributionToJSON,
    ContributionToJSONTyped,
} from './Contribution';

/**
 * 
 * @export
 * @interface ContributionPaginatedResponse1
 */
export interface ContributionPaginatedResponse1 {
    /**
     * 
     * @type {Array<Contribution>}
     * @memberof ContributionPaginatedResponse1
     */
...
/**
 * Check if a given object implements the ContributionPaginatedResponse1 interface.
 */
export function instanceOfContributionPaginatedResponse1(value: object): value is ContributionPaginatedResponse1 {
    return true;
}

export function ContributionPaginatedResponse1FromJSON(json: any): ContributionPaginatedResponse1 {
    return ContributionPaginatedResponse1FromJSONTyped(json, false);
}

export function ContributionPaginatedResponse1FromJSONTyped(json: any, ignoreDiscriminator: boolean): ContributionPaginatedResponse1 {
    if (json == null) {
        return json;
    }
    return {
        
        'data': json['data'] == null ? undefined : ((json['data'] as Array<any>).map(ContributionFromJSON)),
        'metadata': json['metadata'] == null ? undefined : MilestonePaginatedResponse1MetadataFromJSON(json['metadata']),
    };
}

export function ContributionPaginatedResponse1ToJSON(json: any): ContributionPaginatedResponse1 {
    return ContributionPaginatedResponse1ToJSONTyped(json, false);
}

export function ContributionPaginatedResponse1ToJSONTyped(value?: ContributionPaginatedResponse1 | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': value['data'] == null ? undefined : ((value['data'] as Array<any>).map(ContributionToJSON)),
