 ...
 * 
 * @export
 * @interface ConfiguredLeaderboardResponse
 */
export interface ConfiguredLeaderboardResponse {
    /**
     * 
     * @type {ConfiguredLeaderboard}
     * @memberof ConfiguredLeaderboardResponse
     */
    data?: ConfiguredLeaderboard;
}

/**
 * Check if a given object implements the ConfiguredLeaderboardResponse interface.
 */
export function instanceOfConfiguredLeaderboardResponse(value: object): value is ConfiguredLeaderboardResponse {
    return true;
}

export function ConfiguredLeaderboardResponseFromJSON(json: any): ConfiguredLeaderboardResponse {
    return ConfiguredLeaderboardResponseFromJSONTyped(json, false);
}

export function ConfiguredLeaderboardResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ConfiguredLeaderboardResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function ConfiguredLeaderboardResponseToJSON(json: any): ConfiguredLeaderboardResponse {
    return ConfiguredLeaderboardResponseToJSONTyped(json, false);
}

export function ConfiguredLeaderboardResponseToJSONTyped(value?: ConfiguredLeaderboardResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
