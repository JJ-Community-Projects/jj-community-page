 ...
 * 
 * @export
 * @interface FundraisingEventResponse1
 */
export interface FundraisingEventResponse1 {
    /**
     * 
     * @type {FundraisingEvent}
     * @memberof FundraisingEventResponse1
     */
    data?: FundraisingEvent;
}

/**
 * Check if a given object implements the FundraisingEventResponse1 interface.
 */
export function instanceOfFundraisingEventResponse1(value: object): value is FundraisingEventResponse1 {
    return true;
}

export function FundraisingEventResponse1FromJSON(json: any): FundraisingEventResponse1 {
    return FundraisingEventResponse1FromJSONTyped(json, false);
}

export function FundraisingEventResponse1FromJSONTyped(json: any, ignoreDiscriminator: boolean): FundraisingEventResponse1 {
    if (json == null) {
        return json;
    }
    return {
        
        'data': json['data'] == null ? undefined : FundraisingEventFromJSON(json['data']),
    };
}

export function FundraisingEventResponse1ToJSON(json: any): FundraisingEventResponse1 {
    return FundraisingEventResponse1ToJSONTyped(json, false);
}

export function FundraisingEventResponse1ToJSONTyped(value?: FundraisingEventResponse1 | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': FundraisingEventToJSON(value['data']),
    };
}
