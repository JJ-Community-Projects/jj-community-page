 ...
 * 
 * @export
 * @interface LeaderboardEntryPaginatedResponse
 */
export interface LeaderboardEntryPaginatedResponse {
    /**
     * 
     * @type {Array<LeaderboardEntry>}
     * @memberof LeaderboardEntryPaginatedResponse
     */
...
/**
 * Check if a given object implements the LeaderboardEntryPaginatedResponse interface.
 */
export function instanceOfLeaderboardEntryPaginatedResponse(value: object): value is LeaderboardEntryPaginatedResponse {
    return true;
}

export function LeaderboardEntryPaginatedResponseFromJSON(json: any): LeaderboardEntryPaginatedResponse {
    return LeaderboardEntryPaginatedResponseFromJSONTyped(json, false);
}

export function LeaderboardEntryPaginatedResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): LeaderboardEntryPaginatedResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function LeaderboardEntryPaginatedResponseToJSON(json: any): LeaderboardEntryPaginatedResponse {
    return LeaderboardEntryPaginatedResponseToJSONTyped(json, false);
}

export function LeaderboardEntryPaginatedResponseToJSONTyped(value?: LeaderboardEntryPaginatedResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
