 ...
 * 
 * @export
 * @interface TargetPaginatedResponse1
 */
export interface TargetPaginatedResponse1 {
    /**
     * 
     * @type {Array<Target>}
     * @memberof TargetPaginatedResponse1
     */
    data?: Array<Target>;
    /**
     * 
...
/**
 * Check if a given object implements the TargetPaginatedResponse1 interface.
 */
export function instanceOfTargetPaginatedResponse1(value: object): value is TargetPaginatedResponse1 {
    return true;
}

export function TargetPaginatedResponse1FromJSON(json: any): TargetPaginatedResponse1 {
    return TargetPaginatedResponse1FromJSONTyped(json, false);
}

export function TargetPaginatedResponse1FromJSONTyped(json: any, ignoreDiscriminator: boolean): TargetPaginatedResponse1 {
    if (json == null) {
        return json;
    }
    return {
        
        'data': json['data'] == null ? undefined : ((json['data'] as Array<any>).map(TargetFromJSON)),
        'metadata': json['metadata'] == null ? undefined : MilestonePaginatedResponse1MetadataFromJSON(json['metadata']),
    };
}

export function TargetPaginatedResponse1ToJSON(json: any): TargetPaginatedResponse1 {
    return TargetPaginatedResponse1ToJSONTyped(json, false);
}

export function TargetPaginatedResponse1ToJSONTyped(value?: TargetPaginatedResponse1 | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': value['data'] == null ? undefined : ((value['data'] as Array<any>).map(TargetToJSON)),
