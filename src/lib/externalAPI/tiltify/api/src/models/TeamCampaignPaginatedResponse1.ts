...
import type { TeamCampaign } from './TeamCampaign';
import {
    TeamCampaignFromJSON,
    TeamCampaignFromJSONTyped,
    TeamCampaignToJSON,
    TeamCampaignToJSONTyped,
} from './TeamCampaign';
 ...
 * 
 * @export
 * @interface TeamCampaignPaginatedResponse1
 */
export interface TeamCampaignPaginatedResponse1 {
    /**
     * 
     * @type {Array<TeamCampaign>}
     * @memberof TeamCampaignPaginatedResponse1
     */
    data?: Array<TeamCampaign>;
    /**
     * 
...
/**
 * Check if a given object implements the TeamCampaignPaginatedResponse1 interface.
 */
export function instanceOfTeamCampaignPaginatedResponse1(value: object): value is TeamCampaignPaginatedResponse1 {
    return true;
}

export function TeamCampaignPaginatedResponse1FromJSON(json: any): TeamCampaignPaginatedResponse1 {
    return TeamCampaignPaginatedResponse1FromJSONTyped(json, false);
}

export function TeamCampaignPaginatedResponse1FromJSONTyped(json: any, ignoreDiscriminator: boolean): TeamCampaignPaginatedResponse1 {
    if (json == null) {
        return json;
    }
    return {
        
        'data': json['data'] == null ? undefined : ((json['data'] as Array<any>).map(TeamCampaignFromJSON)),
        'metadata': json['metadata'] == null ? undefined : MilestonePaginatedResponse1MetadataFromJSON(json['metadata']),
    };
}

export function TeamCampaignPaginatedResponse1ToJSON(json: any): TeamCampaignPaginatedResponse1 {
    return TeamCampaignPaginatedResponse1ToJSONTyped(json, false);
}

export function TeamCampaignPaginatedResponse1ToJSONTyped(value?: TeamCampaignPaginatedResponse1 | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': value['data'] == null ? undefined : ((value['data'] as Array<any>).map(TeamCampaignToJSON)),
