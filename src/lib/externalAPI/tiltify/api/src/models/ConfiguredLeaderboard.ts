 ...
 * @export
 * @interface ConfiguredLeaderboard
 */
export interface ConfiguredLeaderboard {
    /**
     * 
     * @type {Array<LeaderboardEntry>}
     * @memberof ConfiguredLeaderboard
     */
    individual?: Array<LeaderboardEntry>;
    /**
     * 
     * @type {Array<LeaderboardEntry>}
     * @memberof ConfiguredLeaderboard
     */
    team?: Array<LeaderboardEntry>;
    /**
     * 
     * @type {Array<LeaderboardEntry>}
     * @memberof ConfiguredLeaderboard
     */
    weekly?: Array<LeaderboardEntry>;
}

/**
 * Check if a given object implements the ConfiguredLeaderboard interface.
 */
export function instanceOfConfiguredLeaderboard(value: object): value is ConfiguredLeaderboard {
    return true;
}

export function ConfiguredLeaderboardFromJSON(json: any): ConfiguredLeaderboard {
    return ConfiguredLeaderboardFromJSONTyped(json, false);
}

export function ConfiguredLeaderboardFromJSONTyped(json: any, ignoreDiscriminator: boolean): ConfiguredLeaderboard {
    if (json == null) {
        return json;
    }
    return {
        
        'individual': json['individual'] == null ? undefined : ((json['individual'] as Array<any>).map(LeaderboardEntryFromJSON)),
        'team': json['team'] == null ? undefined : ((json['team'] as Array<any>).map(LeaderboardEntryFromJSON)),
        'weekly': json['weekly'] == null ? undefined : ((json['weekly'] as Array<any>).map(LeaderboardEntryFromJSON)),
    };
}

export function ConfiguredLeaderboardToJSON(json: any): ConfiguredLeaderboard {
    return ConfiguredLeaderboardToJSONTyped(json, false);
}

export function ConfiguredLeaderboardToJSONTyped(value?: ConfiguredLeaderboard | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'individual': value['individual'] == null ? undefined : ((value['individual'] as Array<any>).map(LeaderboardEntryToJSON)),
        'team': value['team'] == null ? undefined : ((value['team'] as Array<any>).map(LeaderboardEntryToJSON)),
        'weekly': value['weekly'] == null ? undefined : ((value['weekly'] as Array<any>).map(LeaderboardEntryToJSON)),
    };
}
