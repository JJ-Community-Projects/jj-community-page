 ...
 * 
 * @export
 * @interface NullableUserResponse1
 */
export interface NullableUserResponse1 {
    /**
     * 
     * @type {User}
     * @memberof NullableUserResponse1
     */
    data?: User | null;
}

/**
 * Check if a given object implements the NullableUserResponse1 interface.
 */
export function instanceOfNullableUserResponse1(value: object): value is NullableUserResponse1 {
    return true;
}

export function NullableUserResponse1FromJSON(json: any): NullableUserResponse1 {
    return NullableUserResponse1FromJSONTyped(json, false);
}

export function NullableUserResponse1FromJSONTyped(json: any, ignoreDiscriminator: boolean): NullableUserResponse1 {
    if (json == null) {
        return json;
    }
    return {
...
export function NullableUserResponse1ToJSON(json: any): NullableUserResponse1 {
    return NullableUserResponse1ToJSONTyped(json, false);
}

export function NullableUserResponse1ToJSONTyped(value?: NullableUserResponse1 | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
