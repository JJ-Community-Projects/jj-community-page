...
export interface UserResponse1 {
     ...
     * 
     * @type {User}
     * @memberof UserResponse1
     */
    data?: User;
}

/**
 * Check if a given object implements the UserResponse1 interface.
 */
export function instanceOfUserResponse1(value: object): value is UserResponse1 {
    return true;
}

export function UserResponse1FromJSON(json: any): UserResponse1 {
    return UserResponse1FromJSONTyped(json, false);
}

export function UserResponse1FromJSONTyped(json: any, ignoreDiscriminator: boolean): UserResponse1 {
    if (json == null) {
        return json;
    }
    return {
...
export function UserResponse1ToJSON(json: any): UserResponse1 {
    return UserResponse1ToJSONTyped(json, false);
}

export function UserResponse1ToJSONTyped(value?: UserResponse1 | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
