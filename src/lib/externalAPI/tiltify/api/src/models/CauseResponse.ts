...
export interface CauseResponse {
     ...
     * 
     * @type {Cause}
     * @memberof CauseResponse
     */
    data?: Cause;
}

/**
 * Check if a given object implements the CauseResponse interface.
 */
export function instanceOfCauseResponse(value: object): value is CauseResponse {
    return true;
}

export function CauseResponseFromJSON(json: any): CauseResponse {
    return CauseResponseFromJSONTyped(json, false);
}

export function CauseResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): CauseResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function CauseResponseToJSON(json: any): CauseResponse {
    return CauseResponseToJSONTyped(json, false);
}

export function CauseResponseToJSONTyped(value?: CauseResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
