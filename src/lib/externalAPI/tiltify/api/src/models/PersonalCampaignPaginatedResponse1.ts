...
import type { MilestonePaginatedResponse1Metadata } from './MilestonePaginatedResponse1Metadata';
import {
    MilestonePaginatedResponse1MetadataFromJSON,
    MilestonePaginatedResponse1MetadataFromJSONTyped,
    MilestonePaginatedResponse1MetadataToJSON,
    MilestonePaginatedResponse1MetadataToJSONTyped,
} from './MilestonePaginatedResponse1Metadata';
import type { PersonalCampaign } from './PersonalCampaign';
import {
    PersonalCampaignFromJSON,
    PersonalCampaignFromJSONTyped,
    PersonalCampaignToJSON,
    PersonalCampaignToJSONTyped,
} from './PersonalCampaign';

/**
 * 
 * @export
 * @interface PersonalCampaignPaginatedResponse1
 */
export interface PersonalCampaignPaginatedResponse1 {
    /**
     * 
     * @type {Array<PersonalCampaign>}
     * @memberof PersonalCampaignPaginatedResponse1
     */
    data?: Array<PersonalCampaign>;
    /**
     * 
     * @type {MilestonePaginatedResponse1Metadata}
     * @memberof PersonalCampaignPaginatedResponse1
     */
    metadata?: MilestonePaginatedResponse1Metadata;
}

/**
 * Check if a given object implements the PersonalCampaignPaginatedResponse1 interface.
 */
export function instanceOfPersonalCampaignPaginatedResponse1(value: object): value is PersonalCampaignPaginatedResponse1 {
    return true;
}

export function PersonalCampaignPaginatedResponse1FromJSON(json: any): PersonalCampaignPaginatedResponse1 {
    return PersonalCampaignPaginatedResponse1FromJSONTyped(json, false);
}

export function PersonalCampaignPaginatedResponse1FromJSONTyped(json: any, ignoreDiscriminator: boolean): PersonalCampaignPaginatedResponse1 {
    if (json == null) {
        return json;
    }
    return {
        
        'data': json['data'] == null ? undefined : ((json['data'] as Array<any>).map(PersonalCampaignFromJSON)),
        'metadata': json['metadata'] == null ? undefined : MilestonePaginatedResponse1MetadataFromJSON(json['metadata']),
    };
}

export function PersonalCampaignPaginatedResponse1ToJSON(json: any): PersonalCampaignPaginatedResponse1 {
    return PersonalCampaignPaginatedResponse1ToJSONTyped(json, false);
}

export function PersonalCampaignPaginatedResponse1ToJSONTyped(value?: PersonalCampaignPaginatedResponse1 | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': value['data'] == null ? undefined : ((value['data'] as Array<any>).map(PersonalCampaignToJSON)),
        'metadata': MilestonePaginatedResponse1MetadataToJSON(value['metadata']),
    };
}
