 ...
 * 
 * @export
 * @interface PersonalCampaignResponse
 */
export interface PersonalCampaignResponse {
    /**
     * 
     * @type {PersonalCampaign}
     * @memberof PersonalCampaignResponse
     */
    data?: PersonalCampaign;
}

/**
 * Check if a given object implements the PersonalCampaignResponse interface.
 */
export function instanceOfPersonalCampaignResponse(value: object): value is PersonalCampaignResponse {
    return true;
}

export function PersonalCampaignResponseFromJSON(json: any): PersonalCampaignResponse {
    return PersonalCampaignResponseFromJSONTyped(json, false);
}

export function PersonalCampaignResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): PersonalCampaignResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function PersonalCampaignResponseToJSON(json: any): PersonalCampaignResponse {
    return PersonalCampaignResponseToJSONTyped(json, false);
}

export function PersonalCampaignResponseToJSONTyped(value?: PersonalCampaignResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
