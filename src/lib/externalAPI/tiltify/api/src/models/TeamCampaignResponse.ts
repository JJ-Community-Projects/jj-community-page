 ...
 * 
 * @export
 * @interface TeamCampaignResponse
 */
export interface TeamCampaignResponse {
    /**
     * 
     * @type {TeamCampaign}
     * @memberof TeamCampaignResponse
     */
    data?: TeamCampaign;
}

/**
 * Check if a given object implements the TeamCampaignResponse interface.
 */
export function instanceOfTeamCampaignResponse(value: object): value is TeamCampaignResponse {
    return true;
}

export function TeamCampaignResponseFromJSON(json: any): TeamCampaignResponse {
    return TeamCampaignResponseFromJSONTyped(json, false);
}

export function TeamCampaignResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): TeamCampaignResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function TeamCampaignResponseToJSON(json: any): TeamCampaignResponse {
    return TeamCampaignResponseToJSONTyped(json, false);
}

export function TeamCampaignResponseToJSONTyped(value?: TeamCampaignResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
