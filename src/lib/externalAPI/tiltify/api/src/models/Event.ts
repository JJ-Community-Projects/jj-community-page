 ...
 * @export
 */
export type Event = Campaign | TeamCampaign;
...
export function EventFromJSONTyped(json: any, ignoreDiscriminator: boolean): Event {
    ...
    if (instanceOfCampaign(json)) {
        return CampaignFromJSONTyped(json, true);
    }
    if (instanceOfTeamCampaign(json)) {
        return TeamCampaignFromJSONTyped(json, true);
    }

    return {} as any;
}

export function EventToJSON(json: any): any {
...
export function EventToJSONTyped(value?: Event | null, ignoreDiscriminator: boolean = false): any {
    ...
    if (instanceOfCampaign(value)) {
        return CampaignToJSON(value as Campaign);
    }
    if (instanceOfTeamCampaign(value)) {
        return TeamCampaignToJSON(value as TeamCampaign);
    }
