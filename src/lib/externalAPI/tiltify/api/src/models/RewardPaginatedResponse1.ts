 ...
 * 
 * @export
 * @interface RewardPaginatedResponse1
 */
export interface RewardPaginatedResponse1 {
    /**
     * 
     * @type {Array<Reward>}
     * @memberof RewardPaginatedResponse1
     */
    data?: Array<Reward>;
    /**
     * 
...
/**
 * Check if a given object implements the RewardPaginatedResponse1 interface.
 */
export function instanceOfRewardPaginatedResponse1(value: object): value is RewardPaginatedResponse1 {
    return true;
}

export function RewardPaginatedResponse1FromJSON(json: any): RewardPaginatedResponse1 {
    return RewardPaginatedResponse1FromJSONTyped(json, false);
}

export function RewardPaginatedResponse1FromJSONTyped(json: any, ignoreDiscriminator: boolean): RewardPaginatedResponse1 {
    if (json == null) {
        return json;
    }
    return {
        
        'data': json['data'] == null ? undefined : ((json['data'] as Array<any>).map(RewardFromJSON)),
        'metadata': json['metadata'] == null ? undefined : MilestonePaginatedResponse1MetadataFromJSON(json['metadata']),
    };
}

export function RewardPaginatedResponse1ToJSON(json: any): RewardPaginatedResponse1 {
    return RewardPaginatedResponse1ToJSONTyped(json, false);
}

export function RewardPaginatedResponse1ToJSONTyped(value?: RewardPaginatedResponse1 | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': value['data'] == null ? undefined : ((value['data'] as Array<any>).map(RewardToJSON)),
