 ...
 * 
 * @export
 * @interface CauseContact
 */
export interface CauseContact {
    /**
     * The first line of the contact address
     * @type {string}
     * @memberof CauseContact
     */
...
/**
 * Check if a given object implements the CauseContact interface.
 */
export function instanceOfCauseContact(value: object): value is CauseContact {
    return true;
}

export function CauseContactFromJSON(json: any): CauseContact {
    return CauseContactFromJSONTyped(json, false);
}

export function CauseContactFromJSONTyped(json: any, ignoreDiscriminator: boolean): CauseContact {
    if (json == null) {
        return json;
    }
    return {
...
export function CauseContactToJSON(json: any): CauseContact {
    return CauseContactToJSONTyped(json, false);
}

export function CauseContactToJSONTyped(value?: CauseContact | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
