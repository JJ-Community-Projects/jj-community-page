...
import {
    AuctionItemFromJSON,
    AuctionItemFromJSONTyped,
    AuctionItemToJSON,
    AuctionItemToJSONTyped,
} from './AuctionItem';

/**
 * 
 * @export
 * @interface AuctionItemPaginatedResponse1
 */
export interface AuctionItemPaginatedResponse1 {
    /**
     * 
     * @type {Array<AuctionItem>}
     * @memberof AuctionItemPaginatedResponse1
     */
    data?: Array<AuctionItem>;
    /**
     * 
...
/**
 * Check if a given object implements the AuctionItemPaginatedResponse1 interface.
 */
export function instanceOfAuctionItemPaginatedResponse1(value: object): value is AuctionItemPaginatedResponse1 {
    return true;
}

export function AuctionItemPaginatedResponse1FromJSON(json: any): AuctionItemPaginatedResponse1 {
    return AuctionItemPaginatedResponse1FromJSONTyped(json, false);
}

export function AuctionItemPaginatedResponse1FromJSONTyped(json: any, ignoreDiscriminator: boolean): AuctionItemPaginatedResponse1 {
    if (json == null) {
        return json;
    }
    return {
        
        'data': json['data'] == null ? undefined : ((json['data'] as Array<any>).map(AuctionItemFromJSON)),
        'metadata': json['metadata'] == null ? undefined : MilestonePaginatedResponse1MetadataFromJSON(json['metadata']),
    };
}

export function AuctionItemPaginatedResponse1ToJSON(json: any): AuctionItemPaginatedResponse1 {
    return AuctionItemPaginatedResponse1ToJSONTyped(json, false);
}

export function AuctionItemPaginatedResponse1ToJSONTyped(value?: AuctionItemPaginatedResponse1 | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': value['data'] == null ? undefined : ((value['data'] as Array<any>).map(AuctionItemToJSON)),
