...
export interface DonationMatch {
    ...
    /**
     * Unique Identifier for the donation matches donation.
     * @type {string}
     * @memberof DonationMatch
     */
...
/**
 * Check if a given object implements the DonationMatch interface.
 */
export function instanceOfDonationMatch(value: object): value is DonationMatch {
...
export function DonationMatchFromJSON(json: any): DonationMatch {
    return DonationMatchFromJSONTyped(json, false);
}

export function DonationMatchFromJSONTyped(json: any, ignoreDiscriminator: boolean): DonationMatch {
    if (json == null) {
        return json;
    }
    return {
...
export function DonationMatchToJSON(json: any): DonationMatch {
    return DonationMatchToJSONTyped(json, false);
}

export function DonationMatchToJSONTyped(value?: DonationMatch | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
