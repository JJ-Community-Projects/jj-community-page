...
export interface MeasuredUnit {
     ...
     * measured unit
     * @type {string}
     * @memberof MeasuredUnit
     */
    unit: MeasuredUnitUnitEnum;
    /**
     * Monetary amount
     * @type {string}
     * @memberof MeasuredUnit
 ...
 * @export
 */
export const MeasuredUnitUnitEnum = {
    Seconds: 'seconds',
    Kilometer: 'kilometer',
    Mile: 'mile'
} as const;
export type MeasuredUnitUnitEnum = typeof MeasuredUnitUnitEnum[keyof typeof MeasuredUnitUnitEnum];


/**
 * Check if a given object implements the MeasuredUnit interface.
 */
export function instanceOfMeasuredUnit(value: object): value is MeasuredUnit {
    if (!('unit' in value) || value['unit'] === undefined) return false;
    if (!('value' in value) || value['value'] === undefined) return false;
    return true;
}

export function MeasuredUnitFromJSON(json: any): MeasuredUnit {
    return MeasuredUnitFromJSONTyped(json, false);
}

export function MeasuredUnitFromJSONTyped(json: any, ignoreDiscriminator: boolean): MeasuredUnit {
    if (json == null) {
        return json;
    }
    return {
...
export function MeasuredUnitToJSON(json: any): MeasuredUnit {
    return MeasuredUnitToJSONTyped(json, false);
}

export function MeasuredUnitToJSONTyped(value?: MeasuredUnit | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
