 ...
 * 
 * @export
 * @interface NullableUserResponse
 */
export interface NullableUserResponse {
    /**
     * 
     * @type {User}
     * @memberof NullableUserResponse
     */
    data?: User | null;
}

/**
 * Check if a given object implements the NullableUserResponse interface.
 */
export function instanceOfNullableUserResponse(value: object): value is NullableUserResponse {
    return true;
}

export function NullableUserResponseFromJSON(json: any): NullableUserResponse {
    return NullableUserResponseFromJSONTyped(json, false);
}

export function NullableUserResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): NullableUserResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function NullableUserResponseToJSON(json: any): NullableUserResponse {
    return NullableUserResponseToJSONTyped(json, false);
}

export function NullableUserResponseToJSONTyped(value?: NullableUserResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
