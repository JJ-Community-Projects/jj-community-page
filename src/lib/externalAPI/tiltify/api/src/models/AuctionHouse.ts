...
export interface AuctionHouse {
    /**
     * The amount raised directly by this auction house
     * @type {Money}
     * @memberof AuctionHouse
     */
    amountRaised: Money;
    /**
     * 
    ...
    banner: Image | null;
    /**
     * The ID for the campaign that this auction house is supporting.
     * @type {string}
     * @memberof AuctionHouse
     */
    campaignId: string | null;
    /**
     * The ID for the cause that this auction house is supporting.
     * @type {string}
     * @memberof AuctionHouse
     */
    causeId: string;
    /**
     * A short description about this auction house
     * @type {string}
     * @memberof AuctionHouse
     */
    description: string;
    /**
     * The ID for the fundraising event that this auction house is supporting.
     * @type {string}
     * @memberof AuctionHouse
     */
    ...
    id: string;
    /**
     * When the auction house was created
     * @type {Date}
     * @memberof AuctionHouse
     */
    insertedAt: Date;
    /**
     * The name of this auction house
     * @type {string}
     * @memberof AuctionHouse
     */
    name: string;
    /**
     * The amount of money that is pending from completed auction items
     * @type {Money}
     * @memberof AuctionHouse
     */
    pledgedAmountRaised: Money;
    /**
     * The amount of money that is pending from completed auction items
     * @type {Money}
     * @memberof AuctionHouse
     */
    pledgedTotalAmountRaised: Money;
    /**
     * When the auction house was last published
     * @type {Date}
     * @memberof AuctionHouse
     */
    publishedAt: Date;
    /**
     * When the auction house was retired
     * @type {Date}
     * @memberof AuctionHouse
     */
    retiredAt: Date | null;
    ...
    slug: string;
    /**
     * The status of this auction house
     * @type {string}
     * @memberof AuctionHouse
     */
    status: AuctionHouseStatusEnum;
    /**
     * The ID for the team event that this auction house is supporting.
     * @type {string}
     * @memberof AuctionHouse
     */
    teamEventId: string | null;
    /**
     * The amount raised by this auction house
     * @type {Money}
     * @memberof AuctionHouse
     */
    totalAmountRaised: Money;
    /**
     * When the auction house details were last updated
     * @type {Date}
     * @memberof AuctionHouse
     */
    updatedAt: Date;
    /**
     * This is the full url for the auction house.
     * @type {string}
     * @memberof AuctionHouse
     */
    url: string;
    /**
     * The ID for a User that owns this auction house.
     * @type {string}
     * @memberof AuctionHouse
     */
    userId: string | null;
 ...
 * @export
 */
export const AuctionHouseStatusEnum = {
    Unpublished: 'unpublished',
    Published: 'published',
    Retired: 'retired'
} as const;
export type AuctionHouseStatusEnum = typeof AuctionHouseStatusEnum[keyof typeof AuctionHouseStatusEnum];


/**
 * Check if a given object implements the AuctionHouse interface.
 */
export function instanceOfAuctionHouse(value: object): value is AuctionHouse {
    ...
    if (!('pledgedAmountRaised' in value) || value['pledgedAmountRaised'] === undefined) return false;
    if (!('pledgedTotalAmountRaised' in value) || value['pledgedTotalAmountRaised'] === undefined) return false;
...
export function AuctionHouseFromJSON(json: any): AuctionHouse {
    return AuctionHouseFromJSONTyped(json, false);
}

export function AuctionHouseFromJSONTyped(json: any, ignoreDiscriminator: boolean): AuctionHouse {
    if (json == null) {
        return json;
    }
    return {
        ...
        'banner': ImageFromJSON(json['banner']),
        ...
        'name': json['name'],
        'pledgedAmountRaised': MoneyFromJSON(json['pledged_amount_raised']),
        'pledgedTotalAmountRaised': MoneyFromJSON(json['pledged_total_amount_raised']),
...
export function AuctionHouseToJSON(json: any): AuctionHouse {
    return AuctionHouseToJSONTyped(json, false);
}

export function AuctionHouseToJSONTyped(value?: AuctionHouse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'banner': ImageToJSON(value['banner']),
        ...
        'name': value['name'],
        'pledged_amount_raised': MoneyToJSON(value['pledgedAmountRaised']),
        'pledged_total_amount_raised': MoneyToJSON(value['pledgedTotalAmountRaised']),
