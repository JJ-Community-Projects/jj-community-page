 ...
 * 
 * @export
 * @interface TeamMemberPaginatedResponse1
 */
export interface TeamMemberPaginatedResponse1 {
    /**
     * 
     * @type {Array<TeamMember>}
     * @memberof TeamMemberPaginatedResponse1
     */
...
/**
 * Check if a given object implements the TeamMemberPaginatedResponse1 interface.
 */
export function instanceOfTeamMemberPaginatedResponse1(value: object): value is TeamMemberPaginatedResponse1 {
    return true;
}

export function TeamMemberPaginatedResponse1FromJSON(json: any): TeamMemberPaginatedResponse1 {
    return TeamMemberPaginatedResponse1FromJSONTyped(json, false);
}

export function TeamMemberPaginatedResponse1FromJSONTyped(json: any, ignoreDiscriminator: boolean): TeamMemberPaginatedResponse1 {
    if (json == null) {
        return json;
    }
    return {
        
        'data': json['data'] == null ? undefined : ((json['data'] as Array<any>).map(TeamMemberFromJSON)),
        'metadata': json['metadata'] == null ? undefined : MilestonePaginatedResponse1MetadataFromJSON(json['metadata']),
    };
}

export function TeamMemberPaginatedResponse1ToJSON(json: any): TeamMemberPaginatedResponse1 {
    return TeamMemberPaginatedResponse1ToJSONTyped(json, false);
}

export function TeamMemberPaginatedResponse1ToJSONTyped(value?: TeamMemberPaginatedResponse1 | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': value['data'] == null ? undefined : ((value['data'] as Array<any>).map(TeamMemberToJSON)),
