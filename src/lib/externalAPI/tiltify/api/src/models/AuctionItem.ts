...
export interface AuctionItem {
    /**
     * When the auction item was activated
     * @type {Date}
     * @memberof AuctionItem
     */
    activatedAt: Date | null;
    /**
     * When the auction item was completed
     * @type {Date}
     * @memberof AuctionItem
     */
    completedAt: Date | null;
    /**
     * The description of this auction item
     * @type {string}
     * @memberof AuctionItem
     */
    description: string;
    /**
     * When the auction item ends
     * @type {Date}
     * @memberof AuctionItem
     */
    endsAt: Date;
    /**
     * The amount of the auction item if it was sold
     * @type {Money}
     * @memberof AuctionItem
     */
    ...
    id: string;
    /**
     * Images for this auction item
     * @type {Array<Image>}
     * @memberof AuctionItem
     */
    images: Array<Image>;
    /**
     * When the auction item was created
     * @type {Date}
     * @memberof AuctionItem
     */
    insertedAt: Date | null;
    /**
     * The legal information of this auction item
     * @type {string}
     * @memberof AuctionItem
     */
    legal: string | null;
    /**
     * The name of this auction item
     * @type {string}
     * @memberof AuctionItem
     */
    name: string;
    /**
     * The rules of this auction item
     * @type {string}
     * @memberof AuctionItem
     */
    rules: string | null;
    /**
     * The short description of this auction item
     * @type {string}
     * @memberof AuctionItem
     */
    shortDescription: string | null;
    /**
     * The starting bid amount for this auction item
     * @type {Money}
     * @memberof AuctionItem
     */
    startingBid: Money;
    /**
     * When the auction item starts
     * @type {Date}
     * @memberof AuctionItem
     */
    startsAt: Date;
    /**
     * The status of this auction item
     * @type {string}
     * @memberof AuctionItem
     */
 ...
 * @export
 */
export const AuctionItemStatusEnum = {
    Active: 'active',
    Completed: 'completed',
    Inactive: 'inactive'
} as const;
export type AuctionItemStatusEnum = typeof AuctionItemStatusEnum[keyof typeof AuctionItemStatusEnum];


/**
 * Check if a given object implements the AuctionItem interface.
 */
export function instanceOfAuctionItem(value: object): value is AuctionItem {
    ...
    if (!('fairMarketValue' in value) || value['fairMarketValue'] === undefined) return false;
    ...
    if (!('startingBid' in value) || value['startingBid'] === undefined) return false;
    if (!('startsAt' in value) || value['startsAt'] === undefined) return false;
    if (!('status' in value) || value['status'] === undefined) return false;
    return true;
}

export function AuctionItemFromJSON(json: any): AuctionItem {
    return AuctionItemFromJSONTyped(json, false);
}

export function AuctionItemFromJSONTyped(json: any, ignoreDiscriminator: boolean): AuctionItem {
    if (json == null) {
        return json;
    }
    return {
        
        'activatedAt': (json['activated_at'] == null ? null : new Date(json['activated_at'])),
        'completedAt': (json['completed_at'] == null ? null : new Date(json['completed_at'])),
        'description': json['description'],
        'endsAt': (new Date(json['ends_at'])),
        'fairMarketValue': MoneyFromJSON(json['fair_market_value']),
        'id': json['id'],
        'images': ((json['images'] as Array<any>).map(ImageFromJSON)),
        'insertedAt': (json['inserted_at'] == null ? null : new Date(json['inserted_at'])),
        'legal': json['legal'],
        'name': json['name'],
        'rules': json['rules'],
        'shortDescription': json['short_description'],
        'startingBid': MoneyFromJSON(json['starting_bid']),
        'startsAt': (new Date(json['starts_at'])),
        'status': json['status'],
    };
}

export function AuctionItemToJSON(json: any): AuctionItem {
    return AuctionItemToJSONTyped(json, false);
}

export function AuctionItemToJSONTyped(value?: AuctionItem | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'activated_at': (value['activatedAt'] == null ? null : (value['activatedAt'] as any).toISOString()),
        'completed_at': (value['completedAt'] == null ? null : (value['completedAt'] as any).toISOString()),
        'description': value['description'],
        'ends_at': ((value['endsAt']).toISOString()),
        'fair_market_value': MoneyToJSON(value['fairMarketValue']),
        'id': value['id'],
        'images': ((value['images'] as Array<any>).map(ImageToJSON)),
        'inserted_at': (value['insertedAt'] == null ? null : (value['insertedAt'] as any).toISOString()),
        'legal': value['legal'],
        'name': value['name'],
        'rules': value['rules'],
        'short_description': value['shortDescription'],
        'starting_bid': MoneyToJSON(value['startingBid']),
