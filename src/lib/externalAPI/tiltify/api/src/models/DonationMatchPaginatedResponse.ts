 ...
 * 
 * @export
 * @interface DonationMatchPaginatedResponse
 */
export interface DonationMatchPaginatedResponse {
    /**
     * 
     * @type {Array<DonationMatch>}
     * @memberof DonationMatchPaginatedResponse
     */
...
/**
 * Check if a given object implements the DonationMatchPaginatedResponse interface.
 */
export function instanceOfDonationMatchPaginatedResponse(value: object): value is DonationMatchPaginatedResponse {
    return true;
}

export function DonationMatchPaginatedResponseFromJSON(json: any): DonationMatchPaginatedResponse {
    return DonationMatchPaginatedResponseFromJSONTyped(json, false);
}

export function DonationMatchPaginatedResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): DonationMatchPaginatedResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function DonationMatchPaginatedResponseToJSON(json: any): DonationMatchPaginatedResponse {
    return DonationMatchPaginatedResponseToJSONTyped(json, false);
}

export function DonationMatchPaginatedResponseToJSONTyped(value?: DonationMatchPaginatedResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
