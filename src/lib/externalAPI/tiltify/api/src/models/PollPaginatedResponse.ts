 ...
 * 
 * @export
 * @interface PollPaginatedResponse
 */
export interface PollPaginatedResponse {
    /**
     * 
     * @type {Array<Poll>}
     * @memberof PollPaginatedResponse
     */
    data?: Array<Poll>;
    /**
     * 
...
/**
 * Check if a given object implements the PollPaginatedResponse interface.
 */
export function instanceOfPollPaginatedResponse(value: object): value is PollPaginatedResponse {
    return true;
}

export function PollPaginatedResponseFromJSON(json: any): PollPaginatedResponse {
    return PollPaginatedResponseFromJSONTyped(json, false);
}

export function PollPaginatedResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): PollPaginatedResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function PollPaginatedResponseToJSON(json: any): PollPaginatedResponse {
    return PollPaginatedResponseToJSONTyped(json, false);
}

export function PollPaginatedResponseToJSONTyped(value?: PollPaginatedResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
