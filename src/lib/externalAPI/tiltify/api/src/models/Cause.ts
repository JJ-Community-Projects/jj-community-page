...
import type { CauseContact } from './CauseContact';
import {
    CauseContactFromJSON,
    CauseContactFromJSONTyped,
    CauseContactToJSON,
    CauseContactToJSONTyped,
} from './CauseContact';
...
export interface Cause {
     ...
     * @memberof Cause
     */
    contact: CauseContact;
    /**
     * The currency code used by this cause.
     * @type {string}
     * @memberof Cause
     */
    currencyCode: string;
 ...
 */
export function instanceOfCause(value: object): value is Cause {
    ...
    if (!('governmentId' in value) || value['governmentId'] === undefined) return false;
...
export function CauseFromJSONTyped(json: any, ignoreDiscriminator: boolean): Cause {
    ...
    return {
        ...
        'contact': CauseContactFromJSON(json['contact']),
        ...
        'slug': json['slug'],
        'social': SocialFromJSON(json['social']),
        'updatedAt': (new Date(json['updated_at'])),
    };
}

export function CauseToJSON(json: any): Cause {
    return CauseToJSONTyped(json, false);
}

export function CauseToJSONTyped(value?: Cause | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'contact': CauseContactToJSON(value['contact']),
        'currency_code': value['currencyCode'],
        'description': value['description'],
        'government_id': value['governmentId'],
        'id': value['id'],
        ...
        'slug': value['slug'],
        'social': SocialToJSON(value['social']),
