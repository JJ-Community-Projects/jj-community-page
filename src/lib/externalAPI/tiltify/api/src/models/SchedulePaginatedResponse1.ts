 ...
 * 
 * @export
 * @interface SchedulePaginatedResponse1
 */
export interface SchedulePaginatedResponse1 {
    /**
     * 
     * @type {Array<Schedule>}
     * @memberof SchedulePaginatedResponse1
     */
    data?: Array<Schedule>;
    /**
     * 
...
/**
 * Check if a given object implements the SchedulePaginatedResponse1 interface.
 */
export function instanceOfSchedulePaginatedResponse1(value: object): value is SchedulePaginatedResponse1 {
    return true;
}

export function SchedulePaginatedResponse1FromJSON(json: any): SchedulePaginatedResponse1 {
    return SchedulePaginatedResponse1FromJSONTyped(json, false);
}

export function SchedulePaginatedResponse1FromJSONTyped(json: any, ignoreDiscriminator: boolean): SchedulePaginatedResponse1 {
    if (json == null) {
        return json;
    }
    return {
        
        'data': json['data'] == null ? undefined : ((json['data'] as Array<any>).map(ScheduleFromJSON)),
        'metadata': json['metadata'] == null ? undefined : MilestonePaginatedResponse1MetadataFromJSON(json['metadata']),
    };
}

export function SchedulePaginatedResponse1ToJSON(json: any): SchedulePaginatedResponse1 {
    return SchedulePaginatedResponse1ToJSONTyped(json, false);
}

export function SchedulePaginatedResponse1ToJSONTyped(value?: SchedulePaginatedResponse1 | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': value['data'] == null ? undefined : ((value['data'] as Array<any>).map(ScheduleToJSON)),
