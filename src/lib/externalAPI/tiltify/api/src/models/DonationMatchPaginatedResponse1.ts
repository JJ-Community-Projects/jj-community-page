 ...
 * 
 * @export
 * @interface DonationMatchPaginatedResponse1
 */
export interface DonationMatchPaginatedResponse1 {
    /**
     * 
     * @type {Array<DonationMatch>}
     * @memberof DonationMatchPaginatedResponse1
     */
    data?: Array<DonationMatch>;
    /**
     * 
...
/**
 * Check if a given object implements the DonationMatchPaginatedResponse1 interface.
 */
export function instanceOfDonationMatchPaginatedResponse1(value: object): value is DonationMatchPaginatedResponse1 {
    return true;
}

export function DonationMatchPaginatedResponse1FromJSON(json: any): DonationMatchPaginatedResponse1 {
    return DonationMatchPaginatedResponse1FromJSONTyped(json, false);
}

export function DonationMatchPaginatedResponse1FromJSONTyped(json: any, ignoreDiscriminator: boolean): DonationMatchPaginatedResponse1 {
    if (json == null) {
        return json;
    }
    return {
        
        'data': json['data'] == null ? undefined : ((json['data'] as Array<any>).map(DonationMatchFromJSON)),
        'metadata': json['metadata'] == null ? undefined : MilestonePaginatedResponse1MetadataFromJSON(json['metadata']),
    };
}

export function DonationMatchPaginatedResponse1ToJSON(json: any): DonationMatchPaginatedResponse1 {
    return DonationMatchPaginatedResponse1ToJSONTyped(json, false);
}

export function DonationMatchPaginatedResponse1ToJSONTyped(value?: DonationMatchPaginatedResponse1 | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': value['data'] == null ? undefined : ((value['data'] as Array<any>).map(DonationMatchToJSON)),
