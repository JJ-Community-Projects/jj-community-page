...
import type { LeaderboardEntryAmount } from './LeaderboardEntryAmount';
import {
    LeaderboardEntryAmountFromJSON,
    LeaderboardEntryAmountFromJSONTyped,
    LeaderboardEntryAmountToJSON,
    LeaderboardEntryAmountToJSONTyped,
} from './LeaderboardEntryAmount';
...
export interface LeaderboardEntry {
    ...
    avatar: Image | null;
    /**
     * The change in place of this entry
     * @type {number}
     * @memberof LeaderboardEntry
     */
    heat: number | null;
    ...
    name: string;
    /**
     * This is the full url for the team profile.
     * @type {string}
     * @memberof LeaderboardEntry
     */
    url: string | null;
...
export function LeaderboardEntryFromJSONTyped(json: any, ignoreDiscriminator: boolean): LeaderboardEntry {
    ...
    return {
        ...
        'amount': LeaderboardEntryAmountFromJSON(json['amount']),
...
export function LeaderboardEntryToJSONTyped(value?: LeaderboardEntry | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'amount': LeaderboardEntryAmountToJSON(value['amount']),
