 ...
 * 
 * @export
 * @interface FitnessGoalPaginatedResponse
 */
export interface FitnessGoalPaginatedResponse {
    /**
     * 
     * @type {Array<FitnessGoal>}
     * @memberof FitnessGoalPaginatedResponse
     */
...
/**
 * Check if a given object implements the FitnessGoalPaginatedResponse interface.
 */
export function instanceOfFitnessGoalPaginatedResponse(value: object): value is FitnessGoalPaginatedResponse {
    return true;
}

export function FitnessGoalPaginatedResponseFromJSON(json: any): FitnessGoalPaginatedResponse {
    return FitnessGoalPaginatedResponseFromJSONTyped(json, false);
}

export function FitnessGoalPaginatedResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): FitnessGoalPaginatedResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function FitnessGoalPaginatedResponseToJSON(json: any): FitnessGoalPaginatedResponse {
    return FitnessGoalPaginatedResponseToJSONTyped(json, false);
}

export function FitnessGoalPaginatedResponseToJSONTyped(value?: FitnessGoalPaginatedResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
