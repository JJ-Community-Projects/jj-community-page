 ...
 * 
 * @export
 * @interface AuctionBidPaginatedResponse
 */
export interface AuctionBidPaginatedResponse {
    /**
     * 
     * @type {Array<AuctionBid>}
     * @memberof AuctionBidPaginatedResponse
     */
...
/**
 * Check if a given object implements the AuctionBidPaginatedResponse interface.
 */
export function instanceOfAuctionBidPaginatedResponse(value: object): value is AuctionBidPaginatedResponse {
    return true;
}

export function AuctionBidPaginatedResponseFromJSON(json: any): AuctionBidPaginatedResponse {
    return AuctionBidPaginatedResponseFromJSONTyped(json, false);
}

export function AuctionBidPaginatedResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): AuctionBidPaginatedResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function AuctionBidPaginatedResponseToJSON(json: any): AuctionBidPaginatedResponse {
    return AuctionBidPaginatedResponseToJSONTyped(json, false);
}

export function AuctionBidPaginatedResponseToJSONTyped(value?: AuctionBidPaginatedResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
