 ...
 * 
 * @export
 * @interface FundraisingEventPaginatedResponse
 */
export interface FundraisingEventPaginatedResponse {
    /**
     * 
     * @type {Array<FundraisingEvent>}
     * @memberof FundraisingEventPaginatedResponse
     */
...
/**
 * Check if a given object implements the FundraisingEventPaginatedResponse interface.
 */
export function instanceOfFundraisingEventPaginatedResponse(value: object): value is FundraisingEventPaginatedResponse {
    return true;
}

export function FundraisingEventPaginatedResponseFromJSON(json: any): FundraisingEventPaginatedResponse {
    return FundraisingEventPaginatedResponseFromJSONTyped(json, false);
}

export function FundraisingEventPaginatedResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): FundraisingEventPaginatedResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function FundraisingEventPaginatedResponseToJSON(json: any): FundraisingEventPaginatedResponse {
    return FundraisingEventPaginatedResponseToJSONTyped(json, false);
}

export function FundraisingEventPaginatedResponseToJSONTyped(value?: FundraisingEventPaginatedResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
