...
export interface CampaignPaginatedResponse {
     ...
     * 
     * @type {Array<Campaign>}
     * @memberof CampaignPaginatedResponse
     */
    data?: Array<Campaign>;
    /**
     * 
...
/**
 * Check if a given object implements the CampaignPaginatedResponse interface.
 */
export function instanceOfCampaignPaginatedResponse(value: object): value is CampaignPaginatedResponse {
    return true;
}

export function CampaignPaginatedResponseFromJSON(json: any): CampaignPaginatedResponse {
    return CampaignPaginatedResponseFromJSONTyped(json, false);
}

export function CampaignPaginatedResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): CampaignPaginatedResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function CampaignPaginatedResponseToJSON(json: any): CampaignPaginatedResponse {
    return CampaignPaginatedResponseToJSONTyped(json, false);
}

export function CampaignPaginatedResponseToJSONTyped(value?: CampaignPaginatedResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
