...
export interface RewardClaim {
    /**
     * Public ID for the reward claim
     * @type {string}
...
/**
 * Check if a given object implements the RewardClaim interface.
 */
export function instanceOfRewardClaim(value: object): value is RewardClaim {
    return true;
}

export function RewardClaimFromJSON(json: any): RewardClaim {
    return RewardClaimFromJSONTyped(json, false);
}

export function RewardClaimFromJSONTyped(json: any, ignoreDiscriminator: boolean): RewardClaim {
    if (json == null) {
        return json;
    }
    return {
        ...
        'rewardId': json['reward_id'] == null ? undefined : json['reward_id'],
    };
}

export function RewardClaimToJSON(json: any): RewardClaim {
    return RewardClaimToJSONTyped(json, false);
}

export function RewardClaimToJSONTyped(value?: RewardClaim | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
