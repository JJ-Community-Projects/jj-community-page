...
import type { FundraisingEvent } from './FundraisingEvent';
import {
    FundraisingEventFromJSON,
    FundraisingEventFromJSONTyped,
    FundraisingEventToJSON,
    FundraisingEventToJSONTyped,
 ...
 * 
 * @export
 * @interface FundraisingEventPaginatedResponse1
 */
export interface FundraisingEventPaginatedResponse1 {
    /**
     * 
     * @type {Array<FundraisingEvent>}
     * @memberof FundraisingEventPaginatedResponse1
     */
    data?: Array<FundraisingEvent>;
    /**
     * 
...
/**
 * Check if a given object implements the FundraisingEventPaginatedResponse1 interface.
 */
export function instanceOfFundraisingEventPaginatedResponse1(value: object): value is FundraisingEventPaginatedResponse1 {
    return true;
}

export function FundraisingEventPaginatedResponse1FromJSON(json: any): FundraisingEventPaginatedResponse1 {
    return FundraisingEventPaginatedResponse1FromJSONTyped(json, false);
}

export function FundraisingEventPaginatedResponse1FromJSONTyped(json: any, ignoreDiscriminator: boolean): FundraisingEventPaginatedResponse1 {
    if (json == null) {
        return json;
    }
    return {
        
        'data': json['data'] == null ? undefined : ((json['data'] as Array<any>).map(FundraisingEventFromJSON)),
        'metadata': json['metadata'] == null ? undefined : MilestonePaginatedResponse1MetadataFromJSON(json['metadata']),
    };
}

export function FundraisingEventPaginatedResponse1ToJSON(json: any): FundraisingEventPaginatedResponse1 {
    return FundraisingEventPaginatedResponse1ToJSONTyped(json, false);
}

export function FundraisingEventPaginatedResponse1ToJSONTyped(value?: FundraisingEventPaginatedResponse1 | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': value['data'] == null ? undefined : ((value['data'] as Array<any>).map(FundraisingEventToJSON)),
