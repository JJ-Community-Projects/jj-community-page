...
import type { LegacyRelayMeta } from './LegacyRelayMeta';
import {
    LegacyRelayMetaFromJSON,
    LegacyRelayMetaFromJSONTyped,
    LegacyRelayMetaToJSON,
    LegacyRelayMetaToJSONTyped,
} from './LegacyRelayMeta';
 ...
 */
export interface LegacyRelay {
    /**
     * Monetary amount
     * @type {string}
     * @memberof LegacyRelay
     */
    amount?: string;
    /**
     * Wether the donation is anonymous or not
     * @type {boolean}
     * @memberof LegacyRelay
     */
    anonymous?: boolean;
    ...
    /**
     * 
     * @type {LegacyRelayMeta}
     * @memberof LegacyRelay
     */
    meta?: LegacyRelayMeta;
    /**
...
/**
 * Check if a given object implements the LegacyRelay interface.
 */
export function instanceOfLegacyRelay(value: object): value is LegacyRelay {
    return true;
}

export function LegacyRelayFromJSON(json: any): LegacyRelay {
    return LegacyRelayFromJSONTyped(json, false);
}

export function LegacyRelayFromJSONTyped(json: any, ignoreDiscriminator: boolean): LegacyRelay {
    if (json == null) {
        return json;
    }
    return {
        ...
        'donorComment': json['donor_comment'] == null ? undefined : json['donor_comment'],
        'donorName': json['donor_name'] == null ? undefined : json['donor_name'],
        'meta': json['meta'] == null ? undefined : LegacyRelayMetaFromJSON(json['meta']),
        'paymentStatus': json['payment_status'] == null ? undefined : json['payment_status'],
        'uuid': json['uuid'] == null ? undefined : json['uuid'],
    };
}

export function LegacyRelayToJSON(json: any): LegacyRelay {
    return LegacyRelayToJSONTyped(json, false);
}

export function LegacyRelayToJSONTyped(value?: LegacyRelay | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'meta': LegacyRelayMetaToJSON(value['meta']),
