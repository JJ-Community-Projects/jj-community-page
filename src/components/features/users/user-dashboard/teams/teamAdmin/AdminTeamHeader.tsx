...
/**
 * AdminTeamHeader Component
 *
 * Header section for team administration displaying team information and actions.
 * Extracted from AdminTeamSection to improve modularity and maintainability.
 *
 * Features:
 * - Team name and public URL display
 * - Delete team functionality with confirmation dialog
 * - Informational notice about team management
 ...
 */
export const AdminTeamHeader: Component = () => {
  const {
    team,
    deleteTeam,
    deleteTeamMutation
