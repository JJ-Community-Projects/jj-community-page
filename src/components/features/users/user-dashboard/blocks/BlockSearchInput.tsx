  ...
  return (
    <div class="mb-6">
      ...
      <div class="relative">
        ...
        {searchInput().length > 0 && (
          <button
            ...
            class="
              ...
              focus:ring-2 focus:ring-red-500 focus:ring-offset-2 focus:ring-offset-white
        ...
        <div class="absolute inset-0 rounded-xl bg-gradient-to-r from-red-500/5 to-red-600/10 opacity-0 transition-opacity duration-300 pointer-events-none peer-focus:opacity-100"></div>
      </div>
