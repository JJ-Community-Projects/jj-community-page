...
export const ScheduleAdminEditorHeader: Component = () => {
  ...
  createEffect(on(() => deleteMutation.error, (e) => {
      ...
      <div class="bg-white rounded-2xl shadow-xl p-6 mb-6 transition-transform">
        <div class="flex justify-between items-center">
          <div class="flex items-center gap-4">
            <a href={`/dashboard/schedules`} class="text-primary hover:underline flex flex-row gap-1 items-center">
              <FaSolidChevronLeft/><p>Back to Dahboard</p>
            </a>
        ...
        <div class="mt-4 p-3 bg-blue-50 text-blue-700 rounded-lg text-sm">
          <p>The schedule is continuously saved automatically. To make your changes visible to everyone, press
