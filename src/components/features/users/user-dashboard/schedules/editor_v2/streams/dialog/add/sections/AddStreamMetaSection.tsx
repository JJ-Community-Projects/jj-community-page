...
export const AddStreamMetaSection: Component = () => {
  ...
  return (
    <div class="space-y-3">
      ...
      <div class="flex gap-3">
        <TextField class="flex-1" value={dialog.draft.title} onChange={updateTitle}>
        ...
        <Checkbox checked={dialog.draft.visible} onChange={updateVisible} class="flex items-center gap-2">
          <Checkbox.Input class="sr-only"/>
          <Checkbox.Control
            class="h-5 w-5 rounded border border-gray-300 bg-white data-[checked]:bg-blue-600 data-[checked]:border-blue-600">
            <Checkbox.Indicator>
      ...
      <TextField value={dialog.draft.subtitle ?? ""} onChange={updateSubtitle}>
...
export default AddStreamMetaSection;
