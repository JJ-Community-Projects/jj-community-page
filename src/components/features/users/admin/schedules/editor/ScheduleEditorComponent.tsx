...
import {DesktopStreamsList} from "./ScheduleEditorStreamList.tsx";
import "./ScheduleEditorAccordion.css";
import {DebugJSONView} from "../../../../../common/DebugJSONView.tsx";
import {ScheduleEditorConnectionProvider} from "../../providers/ScheduleEditorConnectionProvider.tsx";
import {ScheduleEditorStreamEditDialogBodyProvider} from "./stream/ScheduleEditorStreamEditDialogBodyProvider.tsx";
...
export const ScheduleEditorComponent: Component<ScheduleEditorComponentProps> = (props) => {
  ...
  return (
    <ScheduleEditorConnectionProvider id={props.scheduleId} userId={props.userId} username={props.username}>
        ...
        <div class="max-w-6xl mx-auto px-4 py-8 space-y-6">
          ...
          <div class="bg-white rounded-2xl shadow-xl p-6">
            ...
            <ScheduleEditorStreamEditDialogBodyProvider>
              <Show when={isDesktop()} fallback={<DesktopStreamsList/>}>
                <DesktopStreamsList/>
              </Show>
            </ScheduleEditorStreamEditDialogBodyProvider>
          </div>
    ...
    </ScheduleEditorConnectionProvider>
  );
}


const DEBUG = () => {
  const {local} = useScheduleEditor()
  return (
    <DebugJSONView data={local} title={'Tinybase schedule'}/>
  )
}
