...
export const ScheduleDayVertical: Component<ScheduleDayProps> = (props) => {
  return (
...
const ScheduleDayBody: Component<ScheduleDayBodyProps> = props => {
  return (
    <div class="flex flex-col gap-2 mt-2">
      <For each={props.day.streams}>{stream => <ScheduleStreamCard stream={stream} type="filled" hover={false}/>}</For>
    </div>
  )
}
