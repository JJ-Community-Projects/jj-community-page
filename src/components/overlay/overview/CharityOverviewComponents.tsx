    ...
    <div>
      <div class={'w-[50%] text-white'}>
        ...
        <button
          ...
          onclick={() => {
            console.log('copy')
            const overlay = `https://jinglejam.ostof.dev/overlays/charities?speed=${speed()}&theme=${theme()}&tiltifyurl=${url()}&titlelogo=${titleLogo()}`
...
export const CharitiesOverviewComponent2 = () => {
  ...
  const url = () => {
    let url = 'https://jinglejam.ostof.dev/overlays/charities2?'
    if (import.meta.env.DEV) {
      url = 'http://localhost:5001/overlays/charities2?'
    }
                ...
                <tr>
                  ...
                  <td>
                    ...
                    >
                      ...
                      <option class={'text-black'} value={'carousel'}>
                        Carousel
                      </option>
                    </select>
                  </td>
