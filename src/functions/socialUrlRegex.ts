...
export function socialUrlRegex() {
  return {
    ...
    bsky: /^https?:\/\/(www\.)?bsky\.app\/profile\/([a-zA-Z0-9_.]+(@[a-zA-Z0-9-.]+|\.bsky\.social|(\.[a-zA-Z0-9-]+){2,}))$/, // bsky.app/profile/USER@domain.com or bsky.app/profile/username.bsky.social or bsky.app/profile/username.customdomain.com
