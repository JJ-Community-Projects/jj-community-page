/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 93c183270126c705228c8a6f8a447297)
// Runtime types generated with workerd@1.20250525.0 2025-04-07 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		...
		TeamDO: DurableObjectNamespace<import("./src/worker").TeamDO>;
		UserRateLimiter: DurableObjectNamespace<import("./src/worker").UserRateLimiter>;
		TwitchAPIDO: DurableObjectNamespace<import("./src/worker").TwitchAPIDO>;
		UserLiveStatusDO: DurableObjectNamespace<import("./src/worker").UserLiveStatusDO>;
		DB: D1Database;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "JJ_DASHBOARD_URL" | "CLOUDFLARE_ACCOUNT_ID" | "CLOUDFLARE_DATABASE_ID" | "CLOUDFLARE_D1_TOKEN" | "TWITCH_CLIENT_ID" | "TWITCH_CLIENT_SECRET" | "TWITCH_REDIRECT_URI" | "ASTRO_DATABASE_FILE" | "TILTIFY_CLIENT_ID" | "TILTIFY_SECRET" | "TILTIFY_API" | "TILTIFY_REDIRECT_URI" | "YOUTUBE_API_KEY" | "PUBLIC_FIREBASE_CONFIG">> {}
}
