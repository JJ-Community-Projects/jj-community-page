/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f53947a80dab32f73b16fbe4bfe0db3c)
// Runtime types generated with workerd@1.20250813.0 2025-04-07 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		KV: KVNamespace;
		ENVIRONMENT: "DEV" | "PRDD" | "BETA";
		CLOUDFLARE_ACCOUNT_ID: string;
		CLOUDFLARE_DATABASE_ID: string;
		CLOUDFLARE_D1_TOKEN: string;
		CLOUDFLARE_LOAD_DEV_VARS_FROM_DOT_ENV: string;
		TWITCH_CLIENT_ID: string;
		TWITCH_CLIENT_SECRET: string;
		TWITCH_REDIRECT_URI: string;
		TILTIFY_CLIENT_ID: string;
		TILTIFY_SECRET: string;
		TILTIFY_API: string;
		TILTIFY_REDIRECT_URI: string;
		YOUTUBE_API_KEY: string;
		PUBLIC_FIREBASE_CONFIG: string;
		ORPC_DEI_SIGNING_KEY: string;
		...
		FriendsListObject: DurableObjectNamespace<import("./src/worker").FriendsListObject>;
		UserTeamInvitesObject: DurableObjectNamespace<import("./src/worker").UserTeamInvitesObject>;
		UserTeamsObject: DurableObjectNamespace<import("./src/worker").UserTeamsObject>;
		TeamAdminInvitesObject: DurableObjectNamespace<import("./src/worker").TeamAdminInvitesObject>;
		TeamAdminMembersObject: DurableObjectNamespace<import("./src/worker").TeamAdminMembersObject>;
		ScheduleEditingObject: DurableObjectNamespace<import("./src/worker").ScheduleEditingObject>;
		ConfigDO: DurableObjectNamespace<import("./src/worker").ConfigDO>;
		TwitchExtensionRateLimiter: DurableObjectNamespace<import("./src/worker").TwitchExtensionRateLimiter>;
		DB: D1Database;
		TWITCH_LIVE_CHECK: Queue;
		YOUTUBE_LIVE_CHECK: Queue;
		TWITCH_LIVE_NOTIFIER: Queue;
		ASSETS: Fetcher;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "CLOUDFLARE_ACCOUNT_ID" | "CLOUDFLARE_DATABASE_ID" | "CLOUDFLARE_D1_TOKEN" | "CLOUDFLARE_LOAD_DEV_VARS_FROM_DOT_ENV" | "TWITCH_CLIENT_ID" | "TWITCH_CLIENT_SECRET" | "TWITCH_REDIRECT_URI" | "TILTIFY_CLIENT_ID" | "TILTIFY_SECRET" | "TILTIFY_API" | "TILTIFY_REDIRECT_URI" | "YOUTUBE_API_KEY" | "PUBLIC_FIREBASE_CONFIG" | "ORPC_DEI_SIGNING_KEY" | "JJ_DASHBOARD_URL" | "VITE_BUILD_DATE">> {}
}
